...
solution-type: Ideas
partner-agencies-non-federal: World Vision, the Australian government, Norwegian
  Agency for Development Cooperation (NORAD), and the United Nations High Commissioner
  for Refugees (UNHCR)
original-post-id: '75862'
...
judging-criteria-9: ''
prize-description-0: At least one award in each of the three categories being
  no smaller than $5,000 and no other award being smaller than $1,500.
prize-cash-amount-0: '50,000'
prize-name-0: Technology to Support Education in Crisis and Conflict Settings
prize-description-1: ''
prize-cash-amount-1: ''
prize-name-1: ''
...
showTitle: true
description: 'The disruption of basic education services due to crisis and conflict
  situations has long-term consequences for students’ educational attainment and development.
  Technology offers an opportunity to reach and teach learners, who often cannot gather
  in traditional school settings in periods of such disruption, and prevent the stalling
  or reversal of educational and literacy gains in affected regions. Education could
  also provide psycho-social support and promote child and youth well-being in these
  settings. All Children Reading: A Grand Challenge for Development (ACR GCD) is looking
  for technology-enabled approaches to provide basic education in one or more of the
  following crisis or conflict situations: Health Crisis, Natural Disaster, and Conflict
  Zones. Proposed Solutions should be usable within the first six months after the
  onset of the crisis or conflict and be usable within the context of a developing
  country.    &nbsp;'
