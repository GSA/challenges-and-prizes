...
description: >-
  ...
  **Phase 1: Design** – Respondents will be asked to submit their concepts for a redesigned mask according to the stipulations in this announcement. Up to 40 regional winners (within up to 4 regions) will be selected to move on to the DRIVe Accelerator Product Pitch Competition, where they will present their design to a panel of experts. Of those finalists, up to 10 will be selected to receive the final prize of up to $10,000 each to create a prototype of their concept. Prototypes and physical products will not be tested in Phase 1, but may be eligible for consideration in future phases.
