...
description: <p><strong>CONGRATULATIONS TO STAGE 1 & 2 WINNERS! See the list of winners:  <a href="https://www.firstresponderuaschallenge.org/finalists.php">See the list of winners.</a> </strong>Entries will be accepted in Stage 3 during the Walk-on Contest December 4 – 18. For any questions related to this Challenge contact: <psprizes@nist.gov>. More details below.</p><p>Join us for this exciting drone (aka unmanned aircraft system or UAS) prize competition using your ingenuity and hardware build expertise to create a concept for a drone prototype. The result of the First Responder UAS Endurance Challenge will support the public safety community and its stakeholders.</p>
...
<!-- Description start -->
### Description
<p><strong>CONGRATULATIONS TO STAGE 1 & 2 WINNERS! See the list of winners: <a href="See the list of winners:  <a href="https://www.firstresponderuaschallenge.org/finalists.php">See the list of winners.</a> </strong>Entries will be accepted in Stage 3 during the Walk-on Contest December 4 – 18. For any questions related to this Challenge contact: <psprizes@nist.gov>. More details below.</p>
