...
<!-- Description start -->
### Description
<p><strong>CONGRATULATIONS TO STAGE 1 & 2 WINNERS! See the list of winners: <a href="{{ site.baseurl }}/assets/document-library/PSCR-UAS-Challenge-Stage1-winners.pdf">See a list of winners.</a> </strong>Entries will be accepted in Stage 3 during the Walk-on Contest December 4 – 18. For any questions related to this Challenge contact: <psprizes@nist.gov>. More details below.</p>
