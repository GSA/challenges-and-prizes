...
Evaluation criteria are the same for both phases; at each deadline, teams can submit a solution that includes data supporting the scientific evaluation criteria they have accomplished to date. Full description, rules, and details of this prize competition are defined on [NEI’s 3-D ROC](https://www.nei.nih.gov/about/goals-and-accomplishments/nei-research-initiatives/3-d-retina-organoid-challenge-3-d-roc/3-d-roc-2020-reduction-practice-challenge) page.
...
* Find detailed evaluation criteria here under "[Evaluation Criteria & Point Allocation](https://www.nei.nih.gov/about/goals-and-accomplishments/nei-research-initiatives/3-d-retina-organoid-challenge-3-d-roc/2017-ideation-challenge/2017-ideation-winner-and-honorable-mention)"    

***\---- Jenn Note: Is link correct ----***
...
***\---- Jenn Note: Did you mean for this text to be in here: "Do you want all of these components? Or are some OR all of the components appropriate?" ----***
...
Submissions for this challenge are being accepted via email at [NEI3dROC@mail.nih.gov](mailto:NEI3dROC@mail.nih.gov)