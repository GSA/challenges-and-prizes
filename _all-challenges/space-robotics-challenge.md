---
ideaSubmitFormInstruction: http://www.spaceroboticschallenge.com
...
tagline: A virtual challenge improving the autonomy and dexterity of humanoid robots
...
judging-end-date: 06/16/2017 12:00 AM
solicitation-methods: ''
advancing-the-agency-mission: ''
rules: http://www.spaceroboticschallenge.com
submission-start-date-1: ''
hide-challenge-timeline: 'No'
judging-start-date: 11/15/2016 12:00 AM
winners-announced-date: 12/31/2000 01:00 AM
cash-prizes-and-non-cash-prize-awards: ''
campaign-owner-email: monsi.roman@nasa.gov
solution-type: Software and apps
partner-agencies-non-federal: Space Center Houston
original-post-id: '155171'
...
number-of-phases: ''
how-to-enter: http://www.spaceroboticschallenge.com
partnerships: ''
groupAttributes:
judging-criteria-description-0: http://www.spaceroboticschallenge.com
...
judging-criteria-9: ''
prize-description-0: 'Engagement Challenge: $10,000  Qualifying Round: 20 teams,
  $15,000 each  Final Competition: 1st $125,000, 2nd $100,000, 3rd $50,000, 4th
  $25,000, plus 6 bonus prizes of $50,000 each available'
prize-cash-amount-0: '1,000,000'
prize-name-0: Centennial Challenges Space Robotics Challenge
prize-description-1: ''
prize-cash-amount-1: ''
prize-name-1: ''
...
showTitle: true
description: The Space Robotics Challenge is a prize competition with a $1,000,000
  total prize purse to be divided among teams that develop software to increase the
  autonomy of dexterous humanoid robots. Teams will use software to control a simulated
  R5 to resolve problems in a virtual environment.    Each team will be required to
  complete two qualification tasks. The qualification tasks will be run independently
  at each team's site. Each team must submit two simulation log files, one for each
  qualification task. The log files will be evaluated by SRC officials. Instructions
  on how to complete the qualification tasks, and generate and submit log files will
  be provided to registrants upon release of the qualifying simulation software (details
  on challenge website). Teams may make any number of attempts at completing the qualification
  tasks, and submit only their best results – one file for each of two tasks. The
  top 20 teams will advance to the final virtual challenge.    The final virtual challenge
  will consist of three tasks involving the life in a (fictional) day of R5 on Mars.  <ol>    <li>Alignment
  of a communication dish.</li>    <li>Repair a solar array.</li>    <li>Find and
  repair an air leak inside a habitat.</li>  </ol>  Each task is composed of multiple
  checkpoints, described in the challenge rules.
