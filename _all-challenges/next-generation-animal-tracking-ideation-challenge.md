...
tagline: Use SmallSat technology in animal telemetry data collection.
...
showTitle: true
description: "<p>Current animal tracking technology provides limited coverage and
  is costly.&nbsp; NASA and The Bureau of Ocean Energy Management (BOEM) are seeking
  your ideas for how to use emerging SmallSat/CubeSat technology along with other
  Space, Stratosphere, Land, and/or Water systems to improve the spatial and temporal
  coverage, spatial accuracy and/or data packet size of animal telemetry data collection
  and tracking.</p>"
