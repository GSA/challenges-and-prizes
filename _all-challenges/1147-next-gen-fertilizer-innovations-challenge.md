...
judging: >-
  ...
  **Nice to have:**
  ...
  2. Does not leave toxic residues on or in the soil following use (Here, “residues” means byproducts after the decomposition of the technology in the environment. Toxicity can be described by a number of means, including existing studies, summaries from either the [EPA Chemical Dashboard](<1. https://comptox.epa.gov/dashboard>) or the [EPA Ecotox Knowledge base](<1. https://cfpub.epa.gov/ecotox/index.cfm>), or whether the constituent chemicals are already listed under the [EPA’s Safer Chemical Ingredients List](<1. https://www.epa.gov/saferchoice/safer-ingredients>) (e.g., there are 63 polymers listed as safer alternatives). Although this criteria does not pertain to inhibitor effects on target organisms (e.g., soil bacteria), which are toxic by design, it does pertain to any decomposition byproducts of inhibitors and other potential solutions, and effects that may occur for non-target organisms);
