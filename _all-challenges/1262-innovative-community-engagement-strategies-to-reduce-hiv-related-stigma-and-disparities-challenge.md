...
description: >-
  ...
  Services (HHS) Office of Minority Health (OMH) in partnership with the OASH
  Office of Infectious Disease and HIV/AIDS Policy (OIDP), is seeking innovative
  and effective approaches (e.g., models, strategies, best practices and/or
  tools) for community engagement and mobilization to reduce HIV stigma and
  improve pre-exposure prophylaxis (PrEP) and antiretroviral therapy (ART)
