---
ideaSubmitFormInstruction: 'Draw a poster about the dangers of carbon monoxide (CO).  <ul>   <li>Ask
  your parent or guardian for permission to enter the poster contest.</li>   <li>If
  your parent or guardian says “yes,” have your parent or guardian fill out the <a
  title="Contest Submission and Parental Consent Form" href="http://www.cpsc.gov/Safety-Education/CO-Contest-2014/Release-Form/"><em>Contest
  Submission and Parental Consent Form</em></a>. THIS IS IMPORTANT!</li>   <li>Scan
  your (1) poster and your (2) <a title="Contest Submission and Parental Consent Form"
  href="http://www.cpsc.gov/Safety-Education/CO-Contest-2014/Release-Form/"><em>Contest
  Submission and</em> <em>Parental Consent Form</em></a> as jpg or pdfs. Jpgs are
  preferred. Each file must be no larger than 1MB, if possible.</li>   <li>Submit
  your poster and <a title="Contest Submission and Parental Consent Form" href="http://www.cpsc.gov/Safety-Education/CO-Contest-2014/Release-Form/"><em>Contest
  Submission and Parental Consent Form</em></a> to the contest online at: <a title="Carbon
  Monoxide Poster Contest" href="http://www.cpsc.gov/cocontest">cpsc.gov/COcontest.</a>
  Only one entry per person, please.</li>  </ul>  <form id="aspnetForm" action="/en/Safety-Education/CO-Contest-2014/"
  method="post" name="aspnetForm">  <div class="wrap">  <div class="main">  <div class="content
  page_content">    <strong>Poster Guidelines:</strong> Artwork must be created solely
  by the student and must be original work by the child entering the contest. Artwork
  cannot have been submitted for a previous CPSC poster contest or previously published.
  Submitted artwork may not contain any elements that violate a third party’s copyright
  or trademark rights. To maintain privacy, entrants should not put their name or
  any personal information on the poster. If there is identifying information on the
  poster, CPSC will remove the information before posting. Do not use CPSC’s logo
  or seal on the poster.    </div>  </div>  </div>  </form>'
...
tagline: Middle school students wanted! Create a poster. Warn people about dangers
  of poisonous carbon monoxide (CO). Stop the invisible killer! Save lives! Win prize
  money!
groupName: Consumer Product Safety Commission
...
campaign-owner: ''
public-voting-start-date: 07/14/2014 07:00 AM
...
rules: '<p>1. Contest Description  The U.S. Consumer Product Safety Commission (CPSC)
  ...
  must consist of one piece of original artwork (8 ½ x 11” poster) and a completed
  Contest Submission and Parental Consent Form.  Contestants must create the poster
  without assistance from others. The poster must not have been submitted to any
  prior CPSC poster contest or published previously. The poster must not contain
  any elements that violate a third party’s copyright or trademark rights.  Entries
  must be submitted on CPSC’s website at: www.cpsc.gov/COcontest. Attached files
  should be in the form of either a PDF or JPG and must be no larger than one
  megabyte each, if possible.  Teachers are encouraged to submit poster entries
  for students, subject to the limitation of one poster entry per student. However,
  to be eligible for a prize, each entry must include a completed Contest Submission
  and Parental Consent Form.  Once a poster is entered, a contestant cannot make
  any changes or alterations to the poster. The approximate date by which the
  judging will be complete is May 1, 2015. All decisions by the judges are final.  By
  submitting an entry to the Contest, the contestant and the contestant’s parent
  or guardian agree to be bound by the Contest’s Official Rules. This Contest
  ...
  a Contest Submission and Parental Consent Form for all contestants and requires
  this consent before CPSC collects, uses, or discloses personal information about
  children under the age of 13. CPSC requires contestants to disclose the minimum
  amount of personal information necessary to participate in the Contest. CPSC
  requires the contest winners’ parent/guardians to  provide their child''s social
  security number to process prize payment. CPSC will contact a contestant only
  through a parent or guardian.  CPSC uses the personal information about a contestant
  to administer the Contest. After obtaining parental or guardian consent via
  a Contest Submission and Parental Consent Form, CPSC will publish the contestant’s
  poster, along with the contestant’s first name, grade level, and state of residence.
  CPSC does not permit contestants to make additional information publicly available
  and will not publish personal information about contestants other than the information
  described above.  CPSC maintains reasonable procedures to protect the confidentiality,
  security, and integrity of personal information collected from children, as
  described in CPSC’s Systems of Records Notice, Privacy Impact Assessment, and
  agency policies and directives. CPSC only discloses personal information as
  required by applicable laws and regulations.  If you have any questions about
  these privacy policies, you may contact CPSC at:  pdavis@cpsc.gov  At any time,
  ...
  or mail after the date of the judging using the information provided by the
  parent or guardian to CPSC. The end date for judging is an approximation and
  may change depending on the number of entries. Each Contest winner must sign
  and return to CPSC, within ten (10) calendar days after the date of notice being
  ...
  representatives (except in the case of willful misconduct) from any claims,
  losses, and damages arising out of their participation in this Contest or any
  Contest-related activities and the acceptance and use, misuse, or possession
  ...
  arising from their participation in the Contest, whether the injury, death,
  damage or loss arises through negligence, or otherwise. Participants will not
  be required to waive claims against CPSC that arise from the unauthorized use
  or disclosure by the agency of the intellectual property, trade secrets, or
  ...
  by law, the right to litigate, to seek injunctive relief, or to make any other
  recourse to judicial or any other procedure in case of disputes or claims resulting
  from, or in connection with this Contest, are hereby excluded, and any contestant
  expressly waives any and all such rights. Certain restrictions may apply. CPSC,
  in consultation with the judges, reserves the right, in CPSC’s discretion, not
  to make an award in one or more categories based on factors such as quality,
  ...
  including those who already have submitted entries. As reflected in the contest
  rules, in addition to other awards one winner will be chosen by public vote
  ...
  Terms and Conditions.  The contest rules state that CPSC will award $500 to
  the winner of a public vote on CPSC’s website from all contest entries.  If
  a contest submission receives multiple votes from the same voter or if votes
  for a submission appear irregular (including but not limited to, votes generated
  by robotic, programmed or other automated means), CPSC reserves the right to:
  disqualify the contest submission from eligibility to win the public vote prize,
  invalidate votes, or take other appropriate action in CPSC’s discretion. If
  the online voting process fails to operate properly or appears to be tampered
  with or tainted with errors, fraud, unfair practices or develops technical difficulties
  of any sort (including computer viruses, bugs, or automatic voting/bots), CPSC
  reserves the right to disqualify applicable contest submissions from eligibility
...
winners-announced-date: 05/01/2015 06:00 PM
cash-prizes-and-non-cash-prize-awards: ''
campaign-owner-email: ''
solution-type: Creative (design & multimedia)
partner-agencies-non-federal: ''
original-post-id: '4072'
...
number-of-phases: ''
how-to-enter: "Draw a poster about the dangers of carbon monoxide (CO).\r\n<ul>\r\n\t<li>Ask
  your parent or guardian for permission to enter the poster contest.</li>\r\n\t<li>If
  your parent or guardian says “yes,” have your parent or guardian fill out the
  <a title=\"Contest Submission and Parental Consent Form\" href=\"http://www.cpsc.gov/Safety-Education/CO-Contest-2014/Release-Form/\"><em>Contest
  Submission and Parental Consent Form</em></a>. THIS IS IMPORTANT!</li>\r\n\t<li>Scan
  your (1) poster and your (2) <a title=\"Contest Submission and Parental Consent
  Form\" href=\"http://www.cpsc.gov/Safety-Education/CO-Contest-2014/Release-Form/\"><em>Contest
  Submission and</em> <em>Parental Consent Form</em></a> as jpg or pdfs. Jpgs
  are preferred. Each file must be no larger than 1MB, if possible.</li>\r\n\t<li>Submit
  your poster and <a title=\"Contest Submission and Parental Consent Form\" href=\"http://www.cpsc.gov/Safety-Education/CO-Contest-2014/Release-Form/\"><em>Contest
  Submission and Parental Consent Form</em></a> to the contest online at: <a title=\"Carbon
  Monoxide Poster Contest\" href=\"http://www.cpsc.gov/cocontest\">cpsc.gov/COcontest.</a>
  Only one entry per person, please.</li>\r\n</ul>\r\n<form id=\"aspnetForm\"
  action=\"/en/Safety-Education/CO-Contest-2014/\" method=\"post\" name=\"aspnetForm\">\r\n<div
  class=\"wrap\">\r\n<div class=\"main\">\r\n<div class=\"content page_content\">\r\n\r\n<strong>Poster
  Guidelines:</strong> Artwork must be created solely by the student and must
  be original work by the child entering the contest. Artwork cannot have been
  submitted for a previous CPSC poster contest or previously published. Submitted
  artwork may not contain any elements that violate a third party’s copyright
  or trademark rights. To maintain privacy, entrants should not put their name
  or any personal information on the poster. If there is identifying information
  on the poster, CPSC will remove the information before posting. Do not use CPSC’s
  logo or seal on the poster.\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</form>"
partnerships: ''
groupAttributes:
judging-criteria-description-0: ''
judging-criteria-percentage-0: '100'
judging-criteria-0: Posters will be evaluated on CO safety message clarity, visual
  appeal and design originality.
...
prize-name-0: 6th Grade Finalist
prize-description-1: ''
prize-cash-amount-1: '500'
prize-name-1: 6th Grade Finalist
prize-cash-amount-10: '1,000'
prize-name-10: Grand Prize Winner
...
prize-description-2: ''
prize-name-2: 6th Grade Finalist
prize-cash-amount-2: '500'
prize-description-3: ''
prize-name-3: 7th Grade Finalist
prize-cash-amount-3: '500'
prize-cash-amount-4: '500'
prize-name-4: 7th Grade Finalist
prize-description-4: ''
prize-cash-amount-5: '500'
prize-name-5: 7th Grade Finalist
prize-description-5: ''
prize-name-6: 8th Grade Finalist
prize-cash-amount-6: '500'
prize-description-6: ''
prize-name-7: 8th Grade Finalist
prize-cash-amount-7: '500'
prize-description-7: ''
prize-description-8: ''
prize-cash-amount-8: '500'
prize-name-8: 8th Grade Finalist
prize-description-9: ''
prize-cash-amount-9: '500'
prize-name-9: Public Vote Winner
...
showTitle: true
description: The U.S. Consumer Product Safety Commission is sponsoring a nationwide
  carbon monoxide (CO) safety poster contest to help warn people about the dangers
  of CO. CO is called the "invisible killer" because you cannot see or smell this
  poisonous gas. Each year, about 400 people die in the United States from unintentional
  CO poisoning from fuel-burning appliances, such as furnaces, gas ranges, water heaters,
  portable generators, and charcoal grills, as well as motor vehicles.  Help stop
  the "invisible killer" by creating an original poster that warns others about the
  dangers of carbon monoxide.    Watch our video about the contest- <a href="http://www.cpsc.gov/en/Newsroom/Multimedia/?vid=70423">Carbon
  Monoxide Poster Contest Video</a>
...
authorEdit: false
permalink: "/challenge/carbon-monoxide-poster-contest/"
