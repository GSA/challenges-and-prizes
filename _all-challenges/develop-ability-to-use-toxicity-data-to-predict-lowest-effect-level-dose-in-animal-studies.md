...
tagline: The Environmental Protection Agency (EPA) is seeking your help in providing
  solutions for how new toxicity data on 1800 chemicals can be used to predict the
  Lowest Effect Level Dose in Animal Studies.
...
non-monetary-incentives-awarded: total payout will be $10,000, with at least one
  award being no smaller than $5,000 and no award being smaller than $2,000. opportunity
  to present their idea to high-profile thought leaders at an upcoming event (ToxCast?
  Data Analysis Summit)
...
showTitle: true
description: EPA is inviting the science and technology community to provide solutions
  using the TopCoder & Innocentive platforms. The first challenge is to identify a
  group of in vitro assays, chemical structural descriptors, and/or chemical properties
  best suited for predicting the LEL. A subsequent challenge will ask for the development
  of algorithms that use ToxCast assay and chemical properties/descriptors to predict
  systemic LELs for chemicals that do not have extensive animal studies.
