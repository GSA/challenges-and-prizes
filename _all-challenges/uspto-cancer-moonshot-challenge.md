---
ideaSubmitFormInstruction: '<script id="mce_1" src="https://www.challenge.gov/wp-includes/js/tinymce/plugins/wpembed/../../../wp-embed.js"
  type="text/javascript"></script>    By Sept. 19, 2016, 5:00 P.M. Eastern Standard
  Time, submit the following items through <a href="http://www.challenge.gov">www.challenge.gov</a>:  <ul>    <li><strong>A
  story (maximum 1,000 words)</strong>.  Written in English, that tells the story
  of your visualization and walks users through “how to use” your visualization. The
  document must describe how your visualization provides meaningful insight, including
  potential actions and/or discoveries.</li>    <li><strong>Access to and testing
  instructions for your submission.</strong> This can be appended to your visualization
  description and does not count toward the 1,000 word maximum.</li>    <li><strong>Link
  to the submission</strong>. We will not accept any submission without a link.</li>  </ul>'
...
why-use-prizes: ''
submission-start: '08/22/2016 12:00 AM'
fiscal-year: FY16
public-voting-end-date: ''
budget-and-resources: ''
total-prize-offered-cash: '$10,000'
campaign-owner: Scott Beliveau
...
rules: '<p>To be eligible to win a prize under this challenge, an individual or entity—  <br>  (1)
  ...
  financially responsible for 1) claims by a third party for death, bodily injury,
  ...
  property rights and/or content that you do not have permission to use;</li>    <li>is
  not obscene, defamatory or in breach of any applicable legislation or regulations.</li>  </ul>  General
  Conditions: USPTO reserves the right to cancel, suspend, and/or modify the Challenge,
  or any part of it, for any reason, at USPTO’s sole discretion.    SUBMISSION
  REQUIREMENTS  <ul>    <li>Each submission must use at least the USPTO Cancer
  research dataset provided.</li>    <li>Your submission must be relevant to a
  U.S. audience and must be in the English language only.</li>    <li>You are
  responsible for the cost and expense (if any) of sending your submission to
  us and, if your submission is selected, either attending in person an awards
  event demo at the USPTO on Sept. 26,2016 or  submitting a video of your presentation
  to be shared at the event.</li>    <li>Only one project submission is permitted
...
judging-start-date: ''
winners-announced-date: '09/27/2016 12:00 PM'
cash-prizes-and-non-cash-prize-awards: ''
campaign-owner-email: scott.beliveau@uspto.gov
solution-type: Software and apps
partner-agencies-non-federal: ''
original-post-id: '153581'
...
number-of-phases: ''
how-to-enter: "<script id=\"mce_1\" src=\"https://www.challenge.gov/wp-includes/js/tinymce/plugins/wpembed/../../../wp-embed.js\"
  type=\"text/javascript\"></script>\r\n\r\nBy Sept. 19, 2016, 5:00 P.M. Eastern
  Standard Time, submit the following items through <a href=\"http://www.challenge.gov\">www.challenge.gov</a>:\r\n<ul>\r\n
  \t<li><strong>A story (maximum 1,000 words)</strong>.  Written in English, that
  tells the story of your visualization and walks users through “how to use” your
  visualization. The document must describe how your visualization provides meaningful
  insight, including potential actions and/or discoveries.</li>\r\n \t<li><strong>Access
  to and testing instructions for your submission.</strong> This can be appended
  to your visualization description and does not count toward the 1,000 word maximum.</li>\r\n
  \t<li><strong>Link to the submission</strong>. We will not accept any submission
  without a link.</li>\r\n</ul>"
partnerships: ''
groupAttributes:
judging-criteria-description-0: "- Uniqueness and innovation in approach to revealing
  new insights to guide public policy and research.   - Concept should be original,
  fill a gap or answer a question in a manner that is not already available."
judging-criteria-percentage-0: '20'
judging-criteria-0: Creativity & Innovation
judging-criteria-description-1: "provide meaningful insight, including potential
  actions and discoveries, using patent-related data to better inform funding
  and policy decisions or uncover insights into the cancer R&D process.   - How
  did you arrive at and validate your story? Did you include additional complimentary
  datasets to help solidify your story? What additional knowledge sources did
  you use?"
...
judging-criteria-19: ''
judging-criteria-description-2: Concept should add value to the medical, research,
  or data communities and policymakers — to make more informed funding and policy
  decisions based on the patterns and trends of innovation in cancer diagnosis
  and treatment.
judging-criteria-2: Value to public
judging-criteria-percentage-2: '20'
judging-criteria-description-3: The design elements should attract, engage and
  influence actions from the public and policymakers.
...
judging-criteria-description-4: The visualization should have demonstrable functionality
  as described in project description.
...
prize-cash-amount-9: ''
prize-name-9: ''
winner-solution-description-0: Visualized how the genetics and epidemiology of
  cancer relate to levels of research funding, patenting, and clinical testing
winner-solution-link-0: https://www.challenge.gov/solution/dolcera-visualisation-for-cancer-moonshot-challenge/
winner-name-0: Dolcera
winner-solution-title-0: Dolcera – Visualisation for Cancer Moonshot Challenge
winner-solution-link-1: https://www.challenge.gov/solution/nih-uspto-cancer-network-miner-by-booz-allen-hamilton-and-omnity/
winner-solution-description-1: "Constructed and visualized networks of cancer-related
  patents and federal research grants based on NIH co-funding and the degree of
  linguistic similarity between patent documents.\r\n"
winner-name-1: Booz Allen Hamilton and Omnity
winner-solution-title-1: NIH / USPTO Cancer Network Miner by Booz Allen Hamilton
  and Omnity
winner-solution-description-2: "Illustrated how the epidemiology of cancer mortality
  relates to patenting and funding timelines.\r\n"
winner-solution-link-2: https://www.challenge.gov/solution/cancer-innovation-visualization-and-understanding-cancer-innovationvu/
winner-solution-title-2: Cancer InnovationVU
winner-name-2: Thomson Reuters and the Georgetown Lombardi Comprehensive Cancer
  Center
...
description: '<p>“In his 2016 State of the Union Address, President Obama called upon
  ...
  progress toward a cure.  For example, you could address questions such as:    <span
  style="text-decoration: underline;">Trending</span>:  <ul>    <li>What new insights
  can be revealed by correlating R&amp;D spending/funding to breakthrough technologies?
  How would you define or cluster the broad spectrum of cancer treatments, therapies
  and/or diagnostics?</li>    <li>What would trace studies of commercially successful
  treatments from patent to product tell us? What data insights can be gleaned from
  understanding the time it takes bring patents to patients?</li>    <li>What are
  the peaks and valleys in the landscape of cancer treatment technologies?</li>  </ul>  <span
  style="text-decoration: underline;">Policy</span>:  <ul>    <li>If you were the
  Director of NIH or other agency, given what you have learned from this patent data
  and your research, how would you prioritize your cancer research budget? (FY2014
  National Cancer Institute budget was $4.932 billion).</li>    <li>Based on cluster
  mapping of cancer treatments, therapies and/or diagnostics, what policy would you
  put in place to promote certain technologies? For example, would you promote treatment
  to make cancer a livable disease verses curing?</li>    <li>Is there any measurable
  relationship between patent data, clinical trial data and time to it takes for the
  technology to be in the hands of the patient. If so, how and what catalyst for innovation
  and policy changes would you advise the VPOTUS for the Cancer Moonshot.</li>  </ul>  <p
  style="line-height: 15.0pt; background: white; vertical-align: top; margin: 0in
  0in 7.5pt 0in;"><strong style="line-height: 1.5;">RESOURCES</strong></p>  The USPTO
  has released a curated data set consisting of 269,353 patent documents (published
  patent applications and granted patents) spanning the 1976 to 2016 period.  This
  data and associated documentation explaining our methodology can be found on the
  <a href="https://developer.uspto.gov/product/cancer-moonshot-patent-data">USPTO
  ...
  href="http://www.whitehouse.gov/CancerMoonshot">www.whitehouse.gov/CancerMoonshot</a>.</p>'
