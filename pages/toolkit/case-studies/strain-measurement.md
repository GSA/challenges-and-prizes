            ...
            <section class="portfolio-detail-description">
              <div class="body-text clearfix" itemprop="description">
                ...
                <div class="wp-caption alignleft" style="max-width: 460px">
                  ...
                  <p class="wp-caption-text mt-0">The challenge provided NASA with a simple solution for an inflatable structure with the promise of providing large, habitable volumes within a small launch package. (Photo courtesy of NASA)</p>
