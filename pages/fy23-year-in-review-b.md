...
<div class="row">
  <div width="80%">
    ...
    <img src="{{ site.baseurl }}/assets/images/fy23-banner.png" alt="Fiscal year 2023 challenge and social media data."><br>
    <br>
  </div>
      ...
      <div class="tablet:grid-col-6">
        <div class="usa-card">
          ...
          <svg aria-labelledby="explore-active-challenges" role="img">
            ...
            <h4 class="usa-card__heading text-left user-guide-title"><b>136</b> Prize Competitions</h4>
            <h4 class="usa-card__heading text-left"><b>$173,293,500</b> Total Prize Purse </h4>
            <h4 class="usa-card__heading text-left"><b>$1,274,217</b> Average Prize </h4>
            <h4 class="usa-card__heading text-left"><b>$200,000</b> Median Prize </h4>
            <h4 class="usa-card__heading text-left"><b>24</b> Non-monetary Prizes </h4>
            <h4 class="usa-card__heading text-left"><b>19</b> Agencies </h4><br>
      ...
      <div class="usa-card">
        <div class="usa-card__body text-left">
          ...
          <p>At the beginning of FY22 Challenge.Gov launched a new platform with a dynamic set of features to facilitate the federal government’s use of prize competitions and engage the public. This year, Challenge.Gov is able to show year-over-year increases in key metrics, in</p>
           ...
           <h4 class="usa-card__heading text-left user-guide-title"><b> 733 Total Challenge Manager Accounts
            
            <h4 class="usa-card__heading text-left user-guide-title"><b>4,635</b> Total Challenge Manager Log-ins</b></h4>
            
           <h4 class="usa-card__heading text-left user-guide-title"><b>6,049</b> FY23 Public Solver Accounts</b></h4>
            
            <h4 class="usa-card__heading text-left user-guide-title"><b>11,038</b> Total Public Solver Accounts</b></h4>
            
            <h4 class="usa-card__heading text-left user-guide-title"><b>10,432</b> Total Public Solver Log-ins</b></h4>
            
           <h4 class="usa-card__heading text-left user-guide-title"><b>1,932</b> Total Submissions </h4></b></h4>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <img src="{{ site.baseurl }}/assets/images/map.png" alt="Fiscal year 2023 challenge and social media data."> </div>
    </div>
  </div>
</div>
<br>
  ...
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>1,454 </b><br>
          Customer Service Touchpoints </h4>
      </div>
    </div>
  </div>
  <div class="tablet:grid-col-6">
  ...
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>7,998 </b><br>
          Public Newsletter Subscribers </h4>
      </div>
    </div>
  </div>
  <div class="tablet:grid-col-6">
  ...
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>15,383 </b><br>
          Twitter Followers </h4>
      </div>
    </div>
  </div>
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>4,232 </b><br>
          Facebook Followers </h4>
      </div>
    </div>
  </div>
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>873 </b><br>
          NEW! YouTube Views </h4>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>22</b><br>
          Innovators’ Hour Average Attendance </h4>
      </div>
    </div>
  </div>
  <div class="tablet:grid-col-6">
  ...
  <div class="tablet:grid-col-6">
    <div class="usa-card">
      <div class="usa-card__body text-center">
        ...
        <h4 class="usa-card__heading text-center"><b>59 </b><br>
          Challenge Chats Average Attendance </h4>
      </div>
    </div>
  </div>
</div>
