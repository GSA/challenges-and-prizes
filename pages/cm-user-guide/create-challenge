...
Follow on-screen prompts and enter the challenge details starting with General Info. (See the Challenge Template for additional information regarding each of the data fields.)
...
After completing a section, click Next on the bottom right of the page.  A progress bar appears at the top of the page showing your progress.
NOTE: Click Save at any point to save your work and finish at a later time.
Once all sections have been completed, review your challenge details.
...
Once agency approvals have been received, click Submit for Approval on the bottom right. The Challenge.Gov support team will review your challenge for general content clarity, visibility of graphics, and significant spelling and grammatical errors. Allow up to 2 business days for your request to be processed by the Challenge.Gov support team. Upon completion of the review, the team will either “Approve” for posting or “Recommend Edits”
