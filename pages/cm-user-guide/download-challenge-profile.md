  ...
  <div class="grid-row grid-gap usa-typo">
    <div class="grid-col-12 usa-padding-bottom-10 usa-padding-bottom-30 padding-x-0">
      <div class="bg-secondary-lighter text-center">
        <h2 class="margin-bottom-0">Download Challenge Profile</h2>
      </div>
    </div>
  </div>
    ...
    <div class="grid-col-7">
      <div class="usa-prose">
        ...
        <ol>
          ...
          <li class="font-normal"><span>Select your desired file format (Download CSV or Download JSON) from the options list. Your challenge file will download automatically to your computer’s default download folder.</span></li>
        </ol>
      </div>
    </div>    
