    ...
    <div class="usa-card"> 
      <div class="usa-card__body text-center"> <a href="{{ site.baseurl }}/user-guide/create-your-account/" style="text-decoration: none !important;">
        <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="create-your-account" role="img">
          <title id="create-your-account">ChallengeGov user guide create your account</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#person"></use>
        </svg>
      </svg>
  ...
  <div class="usa-card"> 
    <div class="usa-card__body text-center"> <a href="{{ site.baseurl }}/user-guide/log-into-solver-portal/" style="text-decoration: none !important;">
      <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="logging-in" role="img">
        <title id="logging-in">ChallengeGov user guide logging in</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#lock_open"></use>
      </svg>
    </svg>
  ...
  <div class="usa-card"> 
    <div class="usa-card__body text-center"> <a href="{{ site.baseurl }}/user-guide/remove-saved-challenges/" style="text-decoration: none !important;">
      <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="remove-saved-challenges" role="img">
        <title id="remove-saved-challenges">ChallengeGov user guide remove saved challenges</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#cancel"></use>
      </svg>
    </svg>
  ...
  <div class="usa-card">
    <div class="usa-card__body text-center">  <a href="{{ site.baseurl }}/user-guide/edit-challenge-submissions/" style="text-decoration: none !important;">
      <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="edit-challenge-submissions" role="img">
        <title id="edit-challenge-submissions">ChallengeGov user guide edit challenge submissions</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#edit"></use>
      </svg>
    </svg>
  ...
  <div class="usa-card">
    <div class="usa-card__body text-center">  <a href="{{ site.baseurl }}/user-guide/delete-challenge-submissions/" style="text-decoration: none !important;">
      <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="delete-challenge-submissions" role="img">
        <title id="delete-challenge-submissions">ChallengeGov user guide delete challenge submissions</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#delete"></use>
      </svg>
    </svg>
    ...
    <div class="usa-card">
      <div class="usa-card__body text-center">  <a href="{{ site.baseurl }}/user-guide/view-messages/" style="text-decoration: none !important;">
        <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="view-messages" role="img">
          <title id="view-messages">ChallengeGov user guide view messages</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#chat"></use>
        </svg>
      </svg>
  ...
  <div class="usa-card">
    <div class="usa-card__body text-center">  <a href="{{ site.baseurl }}/user-guide/reply-to-messages/" style="text-decoration: none !important;">
      <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="reply-to-messages" role="img">
        <title id="reply-to-messages">ChallengeGov user guide reply to messages</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#forum"></use>
      </svg>
    </svg>
  ...
  <div class="usa-card">
    <div class="usa-card__body text-center">  <a href="{{ site.baseurl }}/user-guide/message-center-features/" style="text-decoration: none !important;">
      <svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><svg aria-labelledby="more-features" role="img">
        <title id="more-features">ChallengeGov user guide more features</title>        <use xlink:href="{{ site.baseurl }}/assets/uswds/img/sprite.svg#more_horiz"></use>
      </svg>
    </svg>
