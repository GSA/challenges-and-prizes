---
permalink: /user-guide/log-out-of-solver-portal/
layout: page
title: User Guide for Public Solvers | Log Out of Solver Portal
---
<div class="res-sec">
  <div class="grid-row ">
  ...
  <div class="grid-row grid-gap usa-typo">
    <div class="grid-col-12 usa-padding-bottom-10 usa-padding-bottom-30 padding-x-0">
      <div class="bg-secondary-lighter text-center">
        <h2 class="margin-bottom-0">Log Out of Solver Portal</h2>
      </div>
    </div>
  </div>
