...
<table style="width: 900px; height: 600px; font-size: 14px" border="1">
<tbody>
<tr>
...
<table style="width: 900px; height: 400px; font-size: 14px" border="1">
<tbody>
<tr>
...
<table style="width: 900px; height: 450px; font-size: 14px" border="1">
<tbody>
<tr>
...
<li><strong><em>Technical Outcome</em></strong>&nbsp;&ndash; The extent to which the proposed approach will result in significant improvement in commercially available technology and will potentially result in a technical outcome which enables considerable progress toward the challenge goals. Contestants will be evaluated on the extent to which their proposed approach demonstrates the potential to meet the Challenge Objectives listed in&nbsp;<a href="https://github.com/GSA/challenges-and-prizes/blob/create-1098-first-responder-uas-endurance-challenge/_challenges/1098-first-responder-uas-endurance-challenge.md#bookmark=id.2et92p0">Table B</a>&nbsp;- Drone Design Specification.</li>
</ul>
