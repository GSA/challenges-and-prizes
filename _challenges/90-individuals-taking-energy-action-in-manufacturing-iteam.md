...
judging: <div class="judging-criterias">
 ...
 <h4>Energy Savings and Impact - <strong class="text-primary">50%</strong>
 </h4>
 ...
 <div class="prize-item">
 <h4>Initiative/Leadership - <strong class="text-primary">30%</strong>
 </h4>
 ...
 <div class="prize-item">
 <h4>Innovation - <strong class="text-primary">20%</strong>
 </h4>
...
how-to-enter: <div class="description">
 ...
 <p><strong>Submit entries at <a href="https://americanmadechallenges.org/iteam/" target="_blank" rel="noopener">https://americanmadechallenges.org/iteam/.</a></strong></p></div>
---