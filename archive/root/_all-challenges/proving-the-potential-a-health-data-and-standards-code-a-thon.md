...
tagline: Solve interoperability challenges in healthcare with publicly accessible
  Internet and health-specific tools.
...
rules: For complete rules, including eligibility requirements, see the posted
  <a href="https://www.cccinnovationcenter.com/wp-content/uploads/2017/04/3733_001.pdf"
...
judging-criteria-9: ''
prize-description-0: 'Up to $15,000 will be awarded, with the following ceilings
  on the number of prizes of each amount:  First Prize – $5,000  Second Prize
  – $2,000 each  Third Prize – $1,000 each  Honorable mentions – $500 each'
...
showTitle: true
description: 'This code-a-thon challenges software developers, students, and aspiring
  entrepreneurs to team up and leverage publicly accessible Internet and health-specific
  tools to prove the potential for them to work together to solve tangible interoperability
  challenges in healthcare while maintaining appropriate levels of privacy and security.
  Read the complete <a href="https://www.cccinnovationcenter.com/wp-content/uploads/2017/04/3733_001.pdf"
  target="_blank">Federal Register notice.</a>    Interested participants <strong><span
  style="text-decoration: underline;">must register on the <a href="https://www.cccinnovationcenter.com/challenges/proving-the-potential-a-health-data-and-standards-code-a-thon/">CCS
  Innovation site</a></span></strong>.'
...
authorEdit: false
permalink: "/challenge/proving-the-potential-a-health-data-and-standards-code-a-thon/"
layout: json-page
---