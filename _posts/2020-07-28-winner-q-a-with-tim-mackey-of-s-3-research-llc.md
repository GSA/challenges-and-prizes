...
<!-- #### BACKGROUND -->
<h4 id="background" class="margin-bottom-2">BACKGROUND</h4>
...
"><strong>Was there anything about the application process that you’d change?</strong></p>

No, it was pretty abbreviated and even the video helped us focus our value proposition.

<!-- #### WINNER -->
<h4 id="winner" class="margin-bottom-2">WINNER</h4>
...
<!-- #### ADVICE -->
<h4 id="advice" class="margin-bottom-2">ADVICE</h4>
...
<!-- #### **closing** -->
<h4 id="closing" class="margin-bottom-2"><strong>CLOSING</strong></h4>
