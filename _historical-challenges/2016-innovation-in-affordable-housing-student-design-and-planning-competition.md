...
tagline: Graduate student teams form a plan and create designs in order to address
  a real life issue faced by a public housing authority.
...
campaignAttributes:
  attributes:
    ...
    external-url: http://www.huduser.gov/portal/challenge/home.html
    submission-end-date: 12/10/2015 06:00 PM
    why-use-prizes: ''
    submission-start-date: 10/01/2015 12:00 AM
    fiscal-year: FY 2016
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '30000'
    campaign-owner: Claire Desjardins
    ...
    judging-start-date: ''
    winners-announced-date: 04/19/2016 05:00 PM
    cash-prizes-and-non-cash-prize-awards: ''
    campaign-owner-email: Claire.Y.Desjardins@hud.gov
    solution-type: Creative (design & multimedia)
    partner-agencies-non-federal: ''
    original-post-id: '90661'
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: The winning team receives $20,000, to be split among all
      team members who are U.S. citizens or permanent residents.
    prize-cash-amount-0: '20000'
    prize-name-0: Winning Team
  - prize-description-1: The runner up team will receive $10,000 to be split among
      team members who are U.S. citizens or permanent residents.
    prize-cash-amount-1: '10000'
    prize-name-1: Runner Up
...
showTitle: true
description: '<p style="color: #555555;">The third annual HUD Innovation in Affordable
  Housing Student Design and Planning Competition challenges multi-disciplinary, graduate
  student teams to respond to a real life affordable housing design and planning issue.
  The competition is sponsored by HUD’s Office of Policy Development and Research
  (PD&amp;R). PD&amp;R partners with a public housing authority to create a real scenario
  which will be the focus of the students'' plans. This year''s scenario focuses on
  affordable family housing.</p>  <p style="color: #555555;">Multidisciplinary teams
  must be comprised of a minimum of three students and a maximum of five, plus one
  faculty advisor. Each team must have members representing three different graduate
  level programs; one of which must be from an architectural or design-related program,
  and one of which must be from a non-architectural program. There are many acceptable
  permutations; here is one <strong>example</strong> for clarity:</p>    <ul style="color:
  #555555;" type="disc">   <li>2 M. Architecture candidates</li>   <li>1 M. Planning
  or Public Policy candidate</li>   <li>2 MBA candidates</li>  </ul>  <h4 style="color:
  #2f2b29;">Goals</h4>  <ul style="color: #555555;" type="disc">   <li>Encourage research
  and innovation to create high-quality affordable housing that strengthens the social
  and physical fabric of low- and moderate-income communities and neighborhoods.</li>   <li>Raise
  practitioner and future practitioner capacity to produce more livable and sustainable
  housing for low- and moderate-income people.</li>   <li>Foster cross-cutting team-work
  within the design and community development process.</li>  </ul>'
...
authorEdit: false
permalink: "/challenge/2016-innovation-in-affordable-housing-student-design-and-planning-competition/"
layout: json-page
---