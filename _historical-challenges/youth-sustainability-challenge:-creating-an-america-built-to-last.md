...
tagline: Create a video to tell the world what you are doing in your community to
  foster sustainability and create an America built to last. If your video wins you
  will be invited to a White House event.
groupName: White House
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 06/08/2012 08:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: Public recognition (5)
