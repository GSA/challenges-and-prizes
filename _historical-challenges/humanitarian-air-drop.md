...
tagline: We are looking for an alternative way to drop large amounts Humanitarian
  packages from an aircraft into populated areas with no danger of falling objects
  causing harm to those on the ground
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9932741
    submission-end-date: 05/03/2011 03:00 AM
    why-use-prizes: ''
    submission-start-date: 03/02/2011 05:00 AM
    fiscal-year: FY 2011
    ...
    non-monetary-incentives-awarded: '20000'
...
authorEdit: false
permalink: "/challenge/humanitarian-air-drop/"
layout: json-page
---