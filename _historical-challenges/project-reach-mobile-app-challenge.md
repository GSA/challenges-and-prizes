...
tagline: Real-time Electronic Access for Caregivers and the Homeless (REACH).  Join
  the mobile app challenge to connect those in need to resources in their community.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 06/01/2012 03:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: 'Grand prize: $25000; Finalists (5): $10000'
