...
tagline: Apply existing voluntary consensus standards for metadata common to all open
  government data, and design new health domain specific metadata to classify datasets
  in our growing catalog.
...
campaignAttributes:
  attributes:
    ...
    external-url: http://www.health2con.com/devchallenge/health-data-platform-metadata-challenge/
