...
tagline: A multidisciplinary call to create an application that improves interoperability
  among office-based ophthalmic imaging devices, measurement devices, and EHRs.
...
campaignAttributes:
  attributes:
    ...
    why-use-prizes: ''
    submission-start: 05/14/2012 09:00 PM
    fiscal-year: FY 2012
    ...
    non-monetary-incentives-awarded: '1st: $100000; 2nd: $35000; 3rd: $15000; First
      place earns conference exhibition; Conference invitation; Public recognition'
...
authorEdit: false
permalink: "/challenge/ocular-imaging-challenge/"
layout: json-page
---