...
tagline: Health data can be beautiful.
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: At least $500 for top submission in each category;
      At least $1,000 in prizes (cash prize or iPad Air) for the top entry in the
      Best Overall Visualization Category. Five categories will be awarded at Health
      Datapalooza 2014 in Washington, D.C.
...
showTitle: true
description: Some of medical and healthcare sciences most powerful statements are
  not made in words. Health data has the power to inform, excite, and influence behavior
  that leads to improved health at the individual and population level. To visualize
  is to enlighten! Information in health and medicine is visceral and provides the
  most immediate and influential connection between care providers, researchers, and
  patientsand the best hope for nurturing popular interest.     Health data can be
  beautiful.
