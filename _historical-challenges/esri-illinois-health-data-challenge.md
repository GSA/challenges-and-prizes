...
tagline: Best app based on the ESRI platform using health data
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 11/30/2013 10:00 AM
    why-use-prizes: ''
...
showTitle: true
description: 'Esri is offering a prize for the codathon for the best app based on
  the Esri platform. The winner will get to choose from one of two prizes: a seat
  at the 2014 Esri Developer Summit, or a seat in an Esri instructor led online class.
  These prizes are both valued at approximately $1,000. Developers will be able to
  leverage Esri developer tools, e.g., the JavaScript API for cross-platform deployment,
  or the device-specific mobile SDKs for iOS and Android.'
...
groupId: 165
showTagline: true
name: ESRI Illinois Health Data Challenge
