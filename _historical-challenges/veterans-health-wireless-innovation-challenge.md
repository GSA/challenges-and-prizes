...
tagline: In collaboration with the Veterans Affairs Innovation Initiative (VAi2),
  the West Wireless Health Institute is issuing a call to arms challenge to all innovators,
  bright ideaers, futurists, and all ar
...
campaignAttributes:
  attributes:
    ...
    external-url: http://www.westwirelesshealth.org/
    submission-end-date: 03/16/2011 03:00 AM
    why-use-prizes: ''
...
showTitle: true
description: In collaboration with the Veterans Affairs Innovation Initiative (VAi2),
  the West Wireless Health Institute is issuing a call to arms challenge to all innovators,
  bright ideaers, futurists, and all around smart experts to design an award-winning
  wireless device or application targeting a problem specific to the Department of
  Veterans Affairs regarding care for our Veteran population.
...
authorEdit: false
permalink: "/challenge/veterans-health-wireless-innovation-challenge/"
layout: json-page
---