...
tagline: We are looking for a taxonomy that can uniquely describe any space object
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933738
    submission-end-date: 07/20/2015 12:00 AM
    why-use-prizes: ''
    ...
    rules: 'To receive an award, the Solvers will not have to transfer their exclusive
      IP rights to the Seeker.  Instead, they will grant to the Seeker <em>non-exclusive
      license</em> to practice their solutions.    Submissions to this Challenge must
      be received by 11:59 PM (US Eastern Time) on July 20, 2015.  <strong>Late submissions
      will <span style="text-decoration: underline;">not</span> be considered.</strong>'
    submission-start-date-1: ''
    hide-challenge-timeline: 'No'
    judging-start-date: 07/28/2015 12:00 AM
    winners-announced-date: ''
    cash-prizes-and-non-cash-prize-awards: ''
    campaign-owner-email: ''
    solution-type: ''
    partner-agencies-non-federal: ''
    original-post-id: '80131'
  ...
  - winner-solution-description-0: ''
    ...
    winner-name-0: No winners were selected for this challenge
...
showTitle: true
description: The Seeker requires a scientifically-based taxonomy that can uniquely
  describe any space object with a minimal set of attributes that can be used to accurately
  predict space object behavior as verified and validated by actual sensor measurements.    The
  increasing number of satellites being launched combined with a growing number of
  on-orbit collisions could lead to hazards for all space users.  Space objects often
  do not appear where they are projected to be based on the physical characteristics
  and dynamic models of space objects currently used.  The Seeker requires a scientifically-based
  taxonomy that can uniquely describe any space object with a minimal set of attributes
  (e.g. mathematical basis of parameters) that can be used to accurately predict space
  object behavior as verified and validated by actual sensor measurements.  However,
  the aim is not to introduce a random grouping, but to derive a taxonomy of minimal
  salient parameters corresponding to actual physical and behavioral (for example,
  dynamic) attributes.    This is a Theoretical Challenge that requires only a written
  proposal to be submitted.  The Challenge award will be contingent upon theoretical
  evaluation of the proposal by the Seeker.
