...
tagline: This Challenge is seeking innovative designs for a transportation device
  that can be carried into a combat site by a single rescuer and safely evacuate the
  injured
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9932705
    submission-end-date: 02/29/2012 05:00 AM
    why-use-prizes: ''
    submission-start-date: 12/28/2011 05:00 AM
    fiscal-year: FY 2012
    ...
    non-monetary-incentives-awarded: Maximum of $15000 can be awarded. A primary winner
      was selected for full award and some partial awards were made for ideas that
      would contribute to the needed solution
...
authorEdit: false
permalink: "/challenge/medical-transportation-device-for-combat-rescue/"
layout: json-page
---