...
tagline: In support of President Obama's commitment to a clean energy future, the
  Energy Department announced a new geothermal student competition.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 04/05/2014 04:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: First, second, and third place winners will be
      announced at the Geothermal Resources Council Annual Meeting in Portland, Oregon
      in late September, where the five selected teams will also have an opportunity
      to showcase their work and interact
...
showTitle: true
description: Student teams from leading colleges and universities and high school
  seniors are invited to create concepts for high-quality, high-impact infographics
  and outreach materials that combine accurate, technical information with clear,
  data-backed messages & aesthetic appeal.
...
authorEdit: false
permalink: "/challenge/geoenergy-is-beautiful-2014/"
layout: json-page
---