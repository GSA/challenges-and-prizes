...
tagline: Your help is needed to identify ways to strengthen reviewer training to enhance
  impartiality and fairness in the review of grant applications so NIH can fund the
...
campaignAttributes:
  attributes:
    ...
    why-use-prizes: ''
    submission-start-date: 05/05/2014 04:00 PM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: "$10,000, $5,000"
...
showTitle: true
description: The NIH Center for Scientific Review (CSR) is offering a prize for the
  best idea for enhancement of review training practices to strengthen impartiality
  and fairness in peer review of grant applications. Each idea should be provided
  in sufficient detail to assess its ability to address fairness and impartiality
  with regards to gender, race/ethnicity, institutional affiliation, area of science,
  and amount of research experience of grant applicants.
