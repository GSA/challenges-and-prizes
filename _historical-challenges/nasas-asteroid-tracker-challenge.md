...
tagline: NASA must find ways to observe, track & characterize asteroids that may threaten
  Earth.  NASA needs your help to improve systems needed to identify & track asteroids
  using large arrays of antennas.  For this specific challenge, NASA needs help to
  develop an algorithm that can determine the optimum selection and scheduling of
  sets of antennas (as part of a large, array based deep space radar capability) to
  detect and track multiple asteroids as they travel through space.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: '08/31/2014 12:00 AM'
    why-use-prizes: ''
    submission-start-date: 04/30/2014 04:00 AM
    fiscal-year: FY 2014
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '41500'
    campaign-owner: ''
...
showTitle: true
description: For this specific challenge, NASA needs help to develop an algorithm
  that can determine the optimum selection and scheduling of sets of antennas (as
  part of a large, array based deep space radar capability) to detect and track multiple
  asteroids as they travel through space.
...
authorEdit: false
permalink: "/challenge/nasas-asteroid-tracker-challenge/"
layout: json-page
---