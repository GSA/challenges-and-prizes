...
tagline: Can you develop the best Multi-View Stereo (MVS) 3D mapping algorithm for
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 10/04/2016 09:00 PM
    why-use-prizes: ''
    submission-start-date: '09/06/2016 09:00 PM'
    fiscal-year: FY 2016
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '86000'
    campaign-owner: Dr. Hakjae Kim
    ...
    judging-end-date: 10/10/2016 11:59 PM
    solicitation-methods: ''
    advancing-the-agency-mission: ''
    rules: ''
    submission-start-date-1: ''
    hide-challenge-timeline: 'No'
    judging-start-date: 10/05/2016 12:00 AM
    winners-announced-date: 10/17/2016 12:00 AM
    cash-prizes-and-non-cash-prize-awards: ''
    campaign-owner-email: dni-iarpa-3Dchallenge@iarpa.gov
    solution-type: Technology demonstration and hardware
    partner-agencies-non-federal: "\tJohns Hopkins University Applied Physics Laboratory,
      TopCoder, Booz Allen Hamilton"
    original-post-id: '157546'
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: First place prize winner!
    prize-cash-amount-0: '20000'
    prize-name-0: 1st place
  - prize-description-1: Second place prize winner!
  ...
  - prize-description-2: Third place prize winner!
    prize-name-2: 3rd place
    prize-cash-amount-2: '11000'
  - prize-description-3: Fourth place prize winner!
    prize-name-3: 4th place
    prize-cash-amount-3: '7000'
  - prize-cash-amount-4: '5000'
    prize-name-4: 5th place
    prize-description-4: Fifth place prize winner!
  - prize-cash-amount-5: '15000'
    prize-name-5: Open Source Incentive (3)
    prize-description-5: Three winners!
  - prize-name-6: Gateway Progress Prize Pool
    prize-cash-amount-6: '12000'
    prize-description-6: Two winners!
  - prize-name-7: ''
    prize-cash-amount-7: ''
    prize-description-7: ''
  - prize-description-8: ''
...
showTitle: true
description: 'Intelligence Advanced Research Projects Activity (IARPA), within the
  Office of the Director of National Intelligence (ODNI), is excited to launch the
  Master phase of the Multi-View Stereo 3D Mapping Challenge and wants you to participate! 
  In this challenge, solvers will be asked to generate and submit an algorithm to
  convert high-resolution satellite images to 3D point clouds for the contest datasets.    By
  harnessing the energy and expertise of the crowd, this Challenge aims to:  <ul>    <li>Promote
  and benchmark research in multiple view stereo algorithms applied to satellite imagery.</li>    <li>Stimulate
  various communities to develop and enhance automated methods to derive accurate
  3D point clouds from multi-view satellite imagery, including computer vision, remote
  sensing and photogrammetry.</li>    <li>Foster innovation through crowdsourcing
  and moving beyond current research limitations for 3D point clouds.</li>    <li>Cultivate
  and sustain an ongoing collaborative community dedicated to this technology and
  research.</li>  </ul>'
