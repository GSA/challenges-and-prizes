...
tagline: In partnership with the FAA and NASA, DOT is recognizing the best in aviation
  and aerospace innovation from America's students
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: Recognition by Director
...
showTitle: true
description: The Secretary of Transportation, through the Office of Aviation and International
  Affairs and in conjunction with the FAA and NASA, sponsors an annual competition
  to recognize students in the aviation and aerospace fields.    The Secretary's Recognizing
  Aviation &amp; Aerospace Innovation in Science and Engineering (RAISE) award --
  spurs high school and university students to develop innovative solutions to real-world
  aviation and aerospace challenges.
