...
tagline: Is hypertension under control in your clinical practice or health system?  Tell
  us about it and you could become one of the next Hypertension Control Champions.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 10/10/2014 08:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: Recognition
...
showTitle: true
description: The Million Hearts Hypertension Control Challenge will identify providers
  that have a 70% or better hypertension control rate.   The Challenge is open to
  health care clinicians, medical practices, and health systems.  Interested providers
  will submit a nomination that includes information about the practice, the patients
  served, and processes that support hypertension control.  Selected providers will
  participate in data validation.  Up to 20 Champions will be announced in February
  2015.
...
authorEdit: false
permalink: "/challenge/2014-million-hearts-hypertension-control-challenge/"
layout: json-page
---