...
tagline: EPA is challenging university faculty and students to create innovative projects
  that improve the understanding and use of Toxics Release Inventory data.
...
campaignAttributes:
  attributes:
    ...
    external-url: http://www.epa.gov/toxics-release-inventory-tri-program/2016-tri-university-challenge
    submission-end-date: 03/27/2016 11:59 PM
    why-use-prizes: ''
    submission-start-date: 02/11/2016 12:00 AM
    fiscal-year: FY 2016
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '0'
    campaign-owner: Caitlin Briere
    ...
    campaign-owner-email: briere.caitlin@epa.gov
    solution-type: Ideas
    partner-agencies-non-federal: ''
    original-post-id: '127761'
...
showTitle: true
description: '<p style="line-height: 18.0pt; background: white;"><span style="font-family:
  ''Georgia'',serif; color: #333333;">The 2016 TRI University Challenge aims to increase
  awareness of the TRI Program and data within academic communities; expose students
  to TRI data, tools, and analysis; and generate innovative programs, activities,
  recommendations, or research that improve the accessibility, awareness, and use
  of TRI data.</span></p>  <p style="line-height: 18.0pt; background: white; orphans:
  auto; text-align: start; widows: 1; -webkit-text-stroke-width: 0px; word-spacing:
  0px;"><span style="font-family: ''Georgia'',serif; color: #333333;">EPA is looking
  to academic institutions to help build a diverse portfolio of practical and replicable
  projects that benefit communities, the environment, academic institutions, and the
  TRI Program.</span></p>  <p style="line-height: 18.0pt; background: white; orphans:
  auto; text-align: start; widows: 1; -webkit-text-stroke-width: 0px; word-spacing:
  0px;"><a href="http://www.epa.gov/toxics-release-inventory-tri-program/2016-tri-university-challenge">Read
  more about the challenge.</a></p>'
