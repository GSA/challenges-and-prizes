...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 05/22/2017 12:00 AM
    why-use-prizes: ''
...
description: '<strong>All official entries must be submitted via the <span style="color:
  ...
  allowfullscreen="allowfullscreen"></iframe>    <a href="{{ site.baseurl }}/assets/images/wp-content/2017/02/waterstorage.png"><img
  class="alignnone wp-image-160001 size-medium" src="{{ site.baseurl }}/assets/images/wp-content/2017/02/waterstorage-230x300.png"
