...
tagline: Challenging developers to come up with a mechanism to keep eyes on the street
  and transform ordinary citizens mobile devices into tools that can be used to report
  ERW and land mines
...
campaignAttributes:
  attributes:
    ...
    external-url: ''
    submission-end-date: 07/20/2014 12:00 AM
    why-use-prizes: ''
    submission-start-date: 03/19/2014 12:00 PM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: "$3,000, $1,500, $500. potential exhibits with
      the Department of State, Department of Defense. Top two candidates could have
      their application rolled out in countries affected by ERW, land mines and UXO,
      where their solution can be put to work immediately"
...
showTitle: true
description: Each year, a large number of civilians are killed and injured by unexploded
  weapons such as artillery shells, land mines, mortars, grenades and bombs. To combat
  the problem, the Center for Technology and National Security Policy (CTNSP) at the
  National Defense University is challenging developers to come up with a mechanism
  to keep eyes on the street and transform ordinary citizens mobile devices into tools
  that can be used to report ERW and land mines to the appropriate authorities.
...
authorEdit: false
permalink: "/challenge/explosive-remnants-of-war-erw-and-land-mine-reporting-apps-challenge/"
layout: json-page
---