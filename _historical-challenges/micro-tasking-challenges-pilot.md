...
tagline: This pilot project will launch a series of focused challenges developing
  3D models, software ideas and code, and graphics for NASA projects.
...
campaignAttributes:
  attributes:
    ...
    external-url: ''
    submission-end-date: '09/02/2015 12:00 AM'
    why-use-prizes: ''
    submission-start-date: 07/14/2015 02:00 PM
    fiscal-year: FY 2015
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: Prize pool available across all of the pilot challenges.
...
showTitle: true
description: The pilot will be using platforms like Freelancer.com to engage the crowd
  in developing products that contribute to NASA's mission.
...
authorEdit: false
permalink: "/challenge/micro-tasking-challenges-pilot/"
layout: json-page
---