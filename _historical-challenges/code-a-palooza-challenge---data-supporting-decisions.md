...
tagline: Create interactive data visualization tools using newly-released CMS provider
  data that supports consumers making value-based decisions.
...
campaignAttributes:
  attributes:
    ...
    why-use-prizes: ''
    submission-start: 04/09/2014 12:00 AM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: first place team awarded $20,000, second place
      $10,000 and third $5,000
...
showTitle: true
description: New CMS Medicare Fee-for-Service Provider Utilization and Payment Data
  has great potential to further understanding of health care spending and physician
  practice patterns. Consumers can use the data to help make health choices that are
  the most appropriate for their specific, individual needs. This challenge seeks
  the creation of interactive data visualization tools that communicate complex data
  from multiple sources in ways that support consumer decision making for value based
  health care.
