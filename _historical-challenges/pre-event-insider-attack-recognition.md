...
tagline: A non-invasive approach that will accurately predict when an individual is
  primed to commit a hostile act.
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933546
    submission-end-date: '08/31/2014 08:00 AM'
    why-use-prizes: ''
    submission-start-date: 07/21/2014 08:00 AM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: 'The total payout will be $15,000, with at least
      one award being no smaller than $5,000 and no award being smaller than $2,000. '
...
showTitle: true
description: Todays societies are increasingly experiencing events where a recognized
  member of a group commits a violent act against other members of that group. Whether
  insider attacks occur at school, in the workplace, or in the community at large,
  prescreening processes have generally been ineffective at screening out individuals
  predisposed to violence. The Seeker desires a method to identify indicators of violent
  behavior.
