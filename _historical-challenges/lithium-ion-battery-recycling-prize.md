...
tagline: Develop transformative solutions for safely and economically collecting,
  sorting, storing, and transporting 90% of discarded or spent lithium-ion batteries
  in the United States with the ultimate goal of reintroducing key materials to the
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: '08/01/2019 04:00 PM'
    why-use-prizes: ''
  ...
  - prize-description-0: ''
    ...
    prize-name-0: Up to $1 million in prizes
  - prize-description-1: ''
    prize-cash-amount-1: ''
    prize-name-1: ''
...
groupId: 59
showTagline: true
name: Lithium-Ion Battery Recycling Prize
