...
campaignAttributes:
  attributes:
    ...
    external-url: 'http://crowdsourcing.topcoder.com/nasa-hpc '
...
showTitle: true
description: NASA is looking for qualified people who can download the FUN3D code,
  analyze the performance bottlenecks, and identify possible modifications that might
  lead to reducing overall computational time.
...
authorEdit: false
permalink: "/challenge/high-performance-fast-computing-architecture-challenge/"
layout: json-page
---