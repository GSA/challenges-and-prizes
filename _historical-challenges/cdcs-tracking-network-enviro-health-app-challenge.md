...
campaignAttributes:
  attributes:
    ...
    external-url: http://www.envirohealthchallenge.com
    submission-end-date: 06/23/2017 11:59 PM
    why-use-prizes: ''
    submission-start-date: 04/13/2017 12:00 AM
    fiscal-year: FY 2017
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '30000'
    campaign-owner: Patrick Wall
    ...
    rules: For complete rules, including eligibility requirements, see <a href="http://www.envirohealthchallenge.com">envirohealthchallenge.com</a> or
      the posted <a href="https://www.federalregister.gov/documents/2017/04/07/2017-06974/announcement-of-requirements-and-registration-for-the-enviro-health-app-challenge-and-challenge">Federal
      Register Notice</a>.
    ...
    campaign-owner-email: SensisChallenges@sensisagency.com
    solution-type: Software and apps
    partner-agencies-non-federal: ''
    original-post-id: '161235'
    ...
    number-of-phases: ''
    how-to-enter: 'Participants can register by visiting the Challenge website at:
      <a href="http://envirohealthchallenge.com/">envirohealthchallenge.com</a> anytime
      during the proposal submission period.'
    partnerships: ''
  groupAttributes:
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: One first-place winner will be awarded.
    prize-cash-amount-0: '20000'
    prize-name-0: First Place
  - prize-description-1: One second-place winner will be awarded.
  ...
  - prize-description-2: One third-place winner will be awarded.
...
showTitle: true
description: 'Through this Challenge, we want to seed innovative uses for Tracking
  Network data that explore the connections between the environment and health. The
  solution should be technology-based, interactive and help facilitate simple and
  meaningful information to general public audiences. The application must show the
  potential for what can be done with tracking data, such as:  <ul>    <li>Track data
  indicators</li>    <li>Monitor trends</li>    <li>Provide access to data</li>    <li>Educate
  the public</li>    <li>Identify at-risk populations</li>    <li>Expose potential
  health hazards</li>  </ul>  Submissions for this competition are being accepted
  on a third-party site. Please visit the external site for instructions on submitting:
  <a href="http://www.envirohealthchallenge.com/">envirohealthchallenge.com</a>    If
  you missed the Challenge Kick-off Webinar, you may view it <a href="https://www.dropbox.com/s/v59yml2w9gknqts/Enviro%20Health%20App%20Challenge%20Kickoff%20Webinar.mp4?dl=0">here</a>.'
