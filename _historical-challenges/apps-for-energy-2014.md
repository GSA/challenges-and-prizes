...
tagline: "$100,000 in prizes for the best web and mobile applications that use a featured
  Department of Energy API, tool or idea to solve an energy-related challenge"
...
showTitle: true
description: From Jan. 16 - March 9, we invite individuals and teams to submit functioning
  applications that use one of six featured inputs to solve an energy-related challenge
  in a unique. We will be offering $100,000 in prizes for the best apps that use one
  or more of these featured inputs. Submissions will be judged based on a) the quality
  of the concept, b) the quality of the execution and c) how well the app uses a featured
  input.
