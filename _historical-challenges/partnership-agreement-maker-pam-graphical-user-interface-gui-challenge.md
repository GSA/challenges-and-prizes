...
tagline: Seeks a mechanism to implement a new GUI in PAM
...
campaignAttributes:
  attributes:
    ...
    total-prize-offered-cash: '16700'
...
showTitle: true
description: The NASA Headquarters Partnership Office seeks an innovative mechanism
  to implement a new graphical user interface (GUI) for routing packages on a current
  document management system, the Partnership Agreement Maker (PAM).
...
authorEdit: false
permalink: "/challenge/partnership-agreement-maker-pam-graphical-user-interface-gui-challenge/"
layout: json-page
---