...
tagline: We want to see how you can move America forward!
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: ceremony with Secretary Foxx and other senior
      officials
...
showTitle: true
description: Do you have what it takes to create innovative tools to address our nations
  transportation challenges or revolutionize the way Americans see and understand
  the transportation system they use every day?  Your challenge is to create web-based
  tools, data visualizations, mobile apps, or other innovative technologies to address
  transportation challenges by accessing publicly-available federal and/or local DOT
  datasets.
...
groupId: 286
showTagline: true
name: Data Innovation Challenge
