...
tagline: ONC is challenging developers to create an easy-to-use tool that will make
  post-discharge follow-up appointment scheduling a more effective and shared process
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: '1st (1): $5,000, Special network access, Conference
      invitation, Travel; 2nd (1): Special network access; 3rd (1): Special network
      access'
...
authorEdit: false
permalink: "/challenge/discharge-follow-up-appointment-challenge/"
layout: json-page
---