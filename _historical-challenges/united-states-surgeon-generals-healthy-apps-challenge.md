...
tagline: The Surgeon General is challenging developers to create apps that provide
  tailored health information and empower users to engage in and enjoy healthy behavior.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 12/31/2011 05:00 AM
    why-use-prizes: ''
    ...
    total-submission-received: '72'
    total-number-of-participant: ''
    show-winners-instead-of-prizes: 'No'
    estimated-value-of-partner-contributions: ''
    non-monetary-incentives-awarded: '1st (4): Public recognition, Conference invitation'
...
groupId: 23
showTagline: true
name: United States Surgeon Generals Healthy Apps Challenge
