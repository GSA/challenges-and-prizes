...
tagline: NASA In-Space Manufacturing Logo Challenge
...
showTitle: true
description: This challenge is to develop a logo for NASA's In-Space Manufacturing
  (ISM) project. This project includes the new 3D printer on the International Space
  Station and works to develop new technologies that will allow us to build things
  in space.
