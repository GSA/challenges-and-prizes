...
tagline: A competition to predict the timing, peak and intensity of the 2013-14 flu
  season using digital surveillance data
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: "$75000; Recognition/Featured on Website; Monetary/Prize
...
showTitle: true
description: CDC announces the launch of the Predict the Influenza Season challenge,
  a competition designed to foster innovation in flu activity modeling and prediction.
  The registrant who most successfully predicts the 2013-14 flu season using digital
  surveillance data will receive an award of $75,000 and recognition on the CDC Influenza
  website. Full details of the contest requirements are available via the official
...
authorEdit: false
permalink: "/challenge/predict-the-influenza-season-challenge/"
layout: json-page
---