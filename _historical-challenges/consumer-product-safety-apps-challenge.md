...
tagline: Challenges developers to create applications and innovative tools that raise
  awareness of consumer safety reports submitted to CPSC and of recalls of consumer
  products
...
campaignAttributes:
  attributes:
    ...
    external-url: ''
    submission-end-date: 05/23/2014 12:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: Winners (4), $1,000; Recognition/Featured on
      website; award presentation; invitation to meet CPSC Chairman
...
authorEdit: false
permalink: "/challenge/consumer-product-safety-apps-challenge/"
layout: json-page
---