...
tagline: The U.S. Department of Energy (DOE) is engaging college students to compete
  in the DOE Challenge Home Student Design Competition, and be part of a movement
  to achieve truly sustainable homes.
...
showTitle: true
description: This competition will provide the next generation of architects, engineers,
  construction managers, and entrepreneurs with skills and experience to start careers
  in the field of clean energy and generate creative solutions to real-world problems.  Submissions
  for this competition will demonstrate the teams knowledge and skills to design,
  analyze, and plan the construction of quality, high-performance homes that meet
  or exceed the DOE Challenge Home requirements.
