...
tagline: NIOSH is challenging teams of developers to design a mobile app that will
  be used by the public to query the trusted source site and display the info in an
  easy to view format on a mobile device.
...
showTitle: true
description: 'The NIOSH Trusted-Source web page is the one-stop resource to get reliable
  respirator information. The goal is to create a mobile app that can run on multiple
  platforms, such as Apple iOS, Windows and Android, and that makes the Respirator
  Trusted-Source content selectable and easy-to-use, reaching users with portable
  technology.    FOR FURTHER INFORMATION CONTACT: John Sporrer, phone (412)-386-6435
  or e-mail jsporrer@cdc.gov'
...
authorEdit: false
permalink: "/challenge/respirator-trusted-source-mobile-application-challenge/"
layout: json-page
---