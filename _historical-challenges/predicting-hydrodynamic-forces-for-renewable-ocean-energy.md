...
tagline: The Department of Energy is developing open source software to simulate the
  physics and device components for Wave Energy Conversion.  Join their efforts to
  help harness the power of the oceans!
...
campaignAttributes:
  attributes:
    ...
    why-use-prizes: ''
    submission-start: 10/01/2013 12:00 PM
    fiscal-year: FY 2014
...
showTitle: true
description: The WEC-Sim code currently being developed by the National Renewable
  Energy Laboratory and Sandia National Laboratory utilizes a modular structure that
  allows different physics (e.g. hydrodynamics) and device components to be simulated
  in separate modules. The team proposes to run a code competition to develop an open-source
  frequency domain boundary element method (BEM) module, OpenBEM. WEC-Sim uses the
  BEM module to determine hydrodynamic coefficients and wave excitation forces.
...
authorEdit: false
permalink: "/challenge/predicting-hydrodynamic-forces-for-renewable-ocean-energy/"
layout: json-page
---