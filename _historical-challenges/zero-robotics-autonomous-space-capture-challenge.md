...
tagline: The best algorithm submissions from simulation competitions will be tested
  in zero gravity on real SPHERES satellites aboard the International Space Station
  (ISS).
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 04/26/2012 12:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: Best algorithm submissions from simulati
...
groupId: 281
showTagline: true
name: Zero Robotics Autonomous Space Capture Challenge
