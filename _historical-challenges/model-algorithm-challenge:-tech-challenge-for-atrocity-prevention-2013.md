...
campaignAttributes:
  attributes:
    ...
    submission-end-date: '09/12/2013 06:00 PM'
    why-use-prizes: ''
...
showTitle: true
description: USAID and Humanity United Launch the MODEL algorithm challenge, the last
  in The Tech Challenge for Atrocity Prevention series.
...
authorEdit: false
permalink: "/challenge/model-algorithm-challenge:-tech-challenge-for-atrocity-prevention-2013/"
layout: json-page
---