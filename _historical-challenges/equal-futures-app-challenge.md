...
tagline: The White House Council on Women and Girls is launching the Equal Futures
  App Challenge.  Successful apps will promote civic education and inspire girls to
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 01/19/2013 10:00 AM
    why-use-prizes: ''
...
groupId: 440
showTagline: true
name: Equal Futures App Challenge
privateCampaign: true
ideaCount: 0
memberIdeaAttachmentAllowed: false
authorEdit: false
permalink: "/challenge/equal-futures-app-challenge/"
layout: json-page
---