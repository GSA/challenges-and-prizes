...
tagline: Choose the songs that will be used to wake up the crews on NASA's last space
  shuttle missions.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 11/01/2010 11:00 PM
    why-use-prizes: ''
