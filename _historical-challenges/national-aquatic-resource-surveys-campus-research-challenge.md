...
tagline: College students are invited to develop innovative ways of using EPA's water
  data to better protect aquatic resources.
...
campaignAttributes:
  attributes:
    ...
    external-url: http://water.epa.gov/type/watersheds/monitoring/nars-challenge.cfm
    submission-end-date: 05/15/2014 12:00 AM
    why-use-prizes: ''
    submission-start-date: 02/21/2014 12:00 AM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: "$2,000-$5,000. Winners may be offered opportunities
      to speak on webcasts, at meetings, or at other events."
...
showTitle: true
description: The National Aquatic Resource Survey (NARS) Campus Research Challenge
  gives undergraduate and graduate students the opportunity to use NARS data to conduct
  further scientific research and analysis. This challenge is intended to encourage
  external, innovative research and information development in support of enhanced
  water management at multiple scales.
...
authorEdit: false
permalink: "/challenge/national-aquatic-resource-surveys-campus-research-challenge/"
layout: json-page
---