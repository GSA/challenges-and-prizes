...
campaignAttributes:
  attributes:
    ...
    rules: '<a href="http://www.wildlifecrimetech.org/" target="_blank"><span style="font-family:
      sans-serif; font-size: small;">www.wildlifecrimetech.org</span></a>'
    submission-start-date-1: ''
    hide-challenge-timeline: 'No'
    judging-start-date: ''
    winners-announced-date: ''
    cash-prizes-and-non-cash-prize-awards: ''
    campaign-owner-email: arexhepi@usaid.gov
    solution-type: ''
    partner-agencies-non-federal: ''
    original-post-id: '79282'
  ...
  - winner-solution-description-0: ''
    winner-solution-link-0: http://www.wildlifecrimetech.org
    winner-name-0: ''
...
showTitle: true
description: 'The Wildlife Crime Tech Challenge is calling upon the global community
  to share bold and innovative science and technology solutions to stem the slaughter
  of the world''s wildlife.  <a href="http://www.wildlifecrimetech.org/" target="_blank"><span
  style="font-family: sans-serif; font-size: small;">www.wildlifecrimetech.org</span></a>'
