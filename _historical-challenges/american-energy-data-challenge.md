...
tagline: Over the next year, the U.S. Department of Energy will conduct four contests,
  which will award over $100,000 in prizes for the best ideas, apps, and visualizations.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 02/09/2014 12:00 AM
    why-use-prizes: ''
    submission-start-date: 11/06/2013 05:00 AM
    fiscal-year: FY 2014
...
showTitle: true
description: 'Enter the Contest #1, the Energy Ideas Contest by November 29, 2013.
  This challenge will focus on generating new ideas for using energy data to create
  high-value products, applications, services and research. We will award $10,000
  in prizes for the best idea for using an existing Department of Energy dataset,
  the best idea for a "wish list dataset" that would be extremely valuable if it existed,
  and the best "killer idea" for a new energy-related application or service.'
...
authorEdit: false
permalink: "/challenge/american-energy-data-challenge/"
layout: json-page
---