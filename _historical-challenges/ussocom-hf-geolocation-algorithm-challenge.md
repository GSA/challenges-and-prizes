...
tagline: Help the USSOCOM create an algorithm that utilizes the High Frequency (HF)
  reception capability of the DRT441 Software Defined Radio (SDR) to quickly geolocate
  a target's location.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 05/27/2019 08:59 PM
    why-use-prizes: ''
