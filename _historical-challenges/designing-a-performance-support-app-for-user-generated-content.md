...
tagline: A mobile app that facilitates the collection and creation of content that
  can be organized, accessed, and shared on a smart phone and/or a tablet to improve
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933545
    submission-end-date: '08/10/2014 04:00 AM'
    why-use-prizes: ''
    submission-start-date: 07/11/2014 04:00 AM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: "$20,000 to one winner"
...
showTitle: true
description: Mobile devices are a powerful and personal tool. They are not only communication
  devices, but also high resolution cameras, video and audio recorders, GPSs, information
  repositories, and sensors. Operational users lack a performance support tool that
  allows them to quickly, easily, and effectively capture and organize information
  from existing training, documents and reference guides; supplement it with information
  gathered in the field; and share it with others.
