...
tagline: NASAs astronaut email on the International Space Station (ISS) is currently
  limited due to issues caused by communications disruptions and delays.  To fix this,
  NASA needs a plug-in or extension for Outlook/Exchange Server that converts the
  TCP-based protocols used by Outlook (on-board the ISS) to communicate with an Exchange
  server (on Earth) to instead use the Disruption Tolerant Networking (DTN) Bundle
  Protocol.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 10/27/2014 12:00 AM
    why-use-prizes: ''
    submission-start-date: 04/23/2014 08:00 AM
    fiscal-year: FY 2014
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '36000'
    campaign-owner: ''
...
showTitle: true
description: To fix this, NASA needs a plug-in or extension for Outlook/Exchange Server
  that converts the TCP-based protocols used by Outlook (on-board the ISS) to communicate
  with an Exchange server (on Earth) to instead use the Disruption Tolerant Networking
  (DTN) Bundle Protocol.
...
authorEdit: false
permalink: "/challenge/improve-nasas-astronaut-email-for-iss/"
layout: json-page
---