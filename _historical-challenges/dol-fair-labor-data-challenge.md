...
tagline: Create an innovative tool that lets an informed consumer find out if a business
  is obeying the law when it comes to paying workers properly.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 10/12/2013 03:00 AM
    why-use-prizes: ''
    ...
    total-submission-received: '2'
    total-number-of-participant: ''
    show-winners-instead-of-prizes: 'No'
    estimated-value-of-partner-contributions: ''
    non-monetary-incentives-awarded: Conference invitation; Public recognition
...
groupId: 284
showTagline: true
name: DOL Fair Labor Data Challenge
