...
tagline: We seek a novel concept bomb squad robot.  The goal is a "marsupial" robot,
  which is carried by a typical bomb squad robot and can be placed inside a vehicle
  suspected of harboring an explosive.
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933547
    submission-end-date: 11/27/2014 05:00 AM
    why-use-prizes: ''
    submission-start-date: '08/29/2014 04:00 AM'
    fiscal-year: FY 2014
...
showTitle: true
description: Bomb squads are usually limited to purchasing expensive commercially
  manufactured robots that are limited in utility by functions requiring minimal maintenance,
  but provide common functionality. For innovation to increase and maintenance costs
  to lower, bomb squads need the ability to fabricate their own robots or replacement
  parts quickly and efficiently, or produce unique end-effectors or platform components
  for bomb disposal peculiar operations, all at low cost.
