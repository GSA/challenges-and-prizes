...
tagline: EPA is challenging university faculty and students to create practical projects
  that improve use of Toxics Release Inventory data.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 03/21/2014 04:00 AM
    why-use-prizes: ''
...
showTitle: true
description: The 2014 TRI University Challenge aims to increase awareness of EPA's
  Toxics Release Inventory (TRI) program and data within academic communities; expose
  students to TRI data, tools, and analysis; and generate innovative programs, activities,
...
groupId: 18
showTagline: true
name: 2014 TRI University Challenge
privateCampaign: true
ideaCount: 0
memberIdeaAttachmentAllowed: false
authorEdit: false
permalink: "/challenge/2014-tri-university-challenge/"
layout: json-page
---