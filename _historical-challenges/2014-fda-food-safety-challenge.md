...
tagline: Advancing breakthroughs in foodborne pathogen detection
...
campaignAttributes:
  attributes:
    ...
    why-use-prizes: ''
    submission-start: '09/23/2014 04:00 AM'
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: From the $500,000 prize pool, up to 5 finalists
      will be awarded $20,000 each following the Open Submission phase and judging
      of submissions.  After the Field Accelerator phase and final judging, the winner(s)
      will receive the remainder of the prize money.
...
showTitle: true
description: The 2014 FDA Food Safety Challenge is a call to scientists, academics,
  entrepreneurs, & innovators from all disciplines to submit concepts applying novel
  and/or advanced methodologies to foster revolutionary improvements in foodborne
  pathogen detection.  Concepts should apply cutting-edge techniques to achieve significant
  improvements in the speed of the FDA's detection methods for Salmonella in fresh
  produce.  Up to 5 finalists will refine their concepts during the Challenge with
  FDA coaching.
