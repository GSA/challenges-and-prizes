...
tagline: This Challenge is seeking innovative non-GPS solutions that can help navigate
  in any part of the world without having to set up prepositioned towers or other
  devices.
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933055
    submission-end-date: 03/31/2014 04:00 AM
    why-use-prizes: ''
    submission-start-date: 03/01/2014 05:00 AM
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: at least one award being no smaller than $5,000
      and no award being smaller than $2,000
...
showTitle: true
description: There are numerous alternatives to a Global Positioning System (GPS),
  such as inertial measurement units, terrain following, star trackers, etc. Each
  has benefits and limitations and offer varying levels of precision navigation.  This
  Challenge is seeking innovative non-GPS solutions that can help navigate in any
  part of the world.   Ideally, a solution will be platform agnostic, allowing for
  use with any mode of transportation (e.g. person walking, riding in a car or small
  airplane, etc.).
...
authorEdit: false
permalink: "/challenge/zero-gps-precision-navigation/"
layout: json-page
---