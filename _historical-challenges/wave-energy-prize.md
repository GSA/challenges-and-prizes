...
tagline: The Wave Energy Prize  aims to achieve game-changing improvements in the
  efficiency of Wave Energy Converter (WEC) devices.
...
campaignAttributes:
  attributes:
    ...
    external-url: ''
    submission-end-date: 06/15/2015 12:00 AM
    why-use-prizes: ''
    submission-start-date: 04/27/2015 10:00 AM
    fiscal-year: FY 2015
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '2250000'
    campaign-owner: Wave Energy Prize Administrator
    ...
    non-monetary-incentives-awarded: 'Grand Prize: $1.5 million; Second Place: $500k;
      Third Place: $250k'
    partner-agencies-federal: '0'
    judging-end-date: ''
    solicitation-methods: ''
    advancing-the-agency-mission: ''
    rules: The rules for the Wave Energy Prize can be found at http://waveenergyprize.org/about
    submission-start-date-1: ''
    hide-challenge-timeline: 'No'
    judging-start-date: ''
    winners-announced-date: 11/01/2016 12:00 AM
    cash-prizes-and-non-cash-prize-awards: ''
    campaign-owner-email: info@waveenergyprize.org
    solution-type: Technology demonstration and hardware
    partner-agencies-non-federal: ''
    original-post-id: '78082'
...
showTitle: true
description: 'The Department of Energy (DOE) sponsored <a href="http://waveenergyprize.org/">Wave
  Energy Prize</a> intends to double the state-of-the-art performance of wave energy
  conversion (WEC) devices within two years by encouraging the development of WEC
  devices that capture more energy from ocean waves, ultimately reducing the cost
  of wave energy and making it more competitive with traditional energy solutions.    The
  Wave Energy Prize provides an opportunity for participants to:  <ul>   <li>Win a
  substantial monetary prize.</li>   <li>Receive seed funding to support the build
  of a 1/20<sup>th</sup> scale model WEC device for testing.</li>   <li>Participate
  in two rounds of valuable WEC testing, one of which is at the Navy’s Maneuvering
  and Seakeeping (MASK) Basin in Carderock, Md., the nation’s premier wave testing
  facility, at no cost to the finalist teams.</li>   <li>Benefit from many opportunities
  for investor recognition.</li>   <li>Contribute to the development of innovative
  clean energy technologies that can contribute to the nation’s energy independence.</li>  </ul>'
