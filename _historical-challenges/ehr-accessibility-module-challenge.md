...
tagline: ONC is challenging developers create and test an application that makes it
  easy for disabled consumers to access and interact with the health data stored in
  their EHRs.
...
total-prize-offered-cash: '$85000'
campaign-owner: ''
...
non-monetary-incentives-awarded: '1st (1): $60,000; 2nd (2): $5,000'
...
authorEdit: false
permalink: "/challenge/ehr-accessibility-module-challenge/"
layout: json-page
---