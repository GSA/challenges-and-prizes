...
tagline: The Seeker would like to develop a simple system or approach that can be
  employed with or as a FAST rope to maintain a fast but safe descent rate.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 12/16/2011 05:00 AM
    why-use-prizes: ''
