...
tagline: Seeking ideas on heating and cooling of buildings using thermal storage.
...
campaignAttributes:
  attributes:
    ...
    campaign-owner-email: tyler.grubbs@csra.com
    solution-type: Ideas
    partner-agencies-non-federal: Oak Ridge National Laboratory, Trane
    original-post-id: '163503'
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: A $5,000 cash award will be provided by Trane. Oak Ridge
      National Laboratory may further provide up to $20,000 worth of in-kind technical
      support.
    prize-cash-amount-0: '5000'
    prize-name-0: Cash & In-Kind Development Support
  - prize-description-1: ''
    prize-cash-amount-1: ''
    prize-name-1: ''
...
authorEdit: false
permalink: "/challenge/heating--cooling-with-thermal-storage/"
layout: json-page
---