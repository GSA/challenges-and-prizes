...
tagline: This Challenge seeks a non-invasive method or technology to measure the absolute
  intracranial pressure (i.e., the pressure of the interior of a humans head).
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: "$15000 to be distributed at the discretion of
      the sponsor"
