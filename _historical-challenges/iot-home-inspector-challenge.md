...
tagline: Help consumers identify and apply the latest IoT security updates
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 05/22/2017 12:00 PM
    why-use-prizes: ''
    submission-start-date: 03/01/2017 12:00 PM
    fiscal-year: FY 2016
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '28000'
    campaign-owner: Ruth Yodaiken
    ...
    rules: For official rules and details on how to enter, visit <a href="http://FTC.gov/IoTHomeInspector">FTC.gov/IoTHomeInspector</a>.
    submission-start-date-1: ''
    hide-challenge-timeline: 'No'
    judging-start-date: ''
    winners-announced-date: 07/26/2017 11:00 AM
    cash-prizes-and-non-cash-prize-awards: ''
    campaign-owner-email: ryodaiken@ftc.gov
    solution-type: Ideas
    partner-agencies-non-federal: ''
    original-post-id: '159430'
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: The agency is offering up to $25,000 for the best technical
      solution.
    prize-cash-amount-0: '25000'
    prize-name-0: First Prize
  - prize-description-1: FTC awarded one Honorable Mention prize of $3,000.
  ...
  - winner-solution-description-0: ''
    ...
    winner-name-0: Steve Castle
    winner-solution-title-0: IoT Watchdog
  - winner-solution-link-1: ''
    winner-solution-description-1: ''
    winner-name-1: BJ Black and Michael Birmingham
    winner-solution-title-1: Persistent Internal Network Containment (PINC)
...
showTitle: true
description: 'The Federal Trade Commission (FTC) hosted a prize competition that challenged
  the public to create a technical solution (“tool”) that consumers can use to guard
  against security vulnerabilities in software found on the Internet of Things (IoT)
  devices in their homes.    The FTC asked for a tool that would, at a minimum, help
  protect consumers from security vulnerabilities caused by out-of-date software.
  Contestants had the option of adding features, such as those that would address
  hard-coded, factory default or easy-to-guess passwords.    The prize purse for the
  competition was up to $25,000 for a winner, with $3,000 available for each honorable
  mention winner(s). Winners have been announced.    Click here for more details about
  this competition: <a href="http://FTC.gov/IoTHomeInspector">FTC.gov/IoTHomeInspector</a><em>.</em>'
...
authorEdit: false
permalink: "/challenge/iot-home-inspector-challenge/"
layout: json-page
---