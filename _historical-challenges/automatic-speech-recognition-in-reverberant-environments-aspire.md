...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 02/26/2015 12:00 AM
    why-use-prizes: ''
    submission-start-date: 02/11/2015 12:00 AM
    fiscal-year: FY 2015
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '110000'
...
showTitle: true
description: 'Automatic speech recognition software that works in a variety of acoustic
  ...
  that grail.    <strong>Who We Are: </strong> The Intelligence Advanced Research
  ...
  applied to any human language.    <strong>What We’re Doing: </strong>Previous work
  ...
  or multimicrophone scenario.    <strong>Where We’re Doing This: </strong>Around
  ...
  and even experts in disciplines we haven’t yet considered.    <strong>When We’re
  ...
  may run their software against the data and revise their solutions.    During the
  ...
  before February 27, 2014.    <strong>Why We’re Doing This: </strong>Challenges are
  ...
  of technology.    <strong>Why Participate? </strong>The ASpIRE Challenge gives experts
  ...
  environments and recording scenarios—a reality.    We offered 2 prizes: $30,000
