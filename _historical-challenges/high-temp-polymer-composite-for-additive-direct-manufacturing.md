...
tagline: We are looking for high temperature polymer matrix composites (PMC) that
  can be used for Additive Direct Manufacturing (ADM).
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933053
    submission-end-date: 04/22/2013 09:00 PM
    why-use-prizes: ''
    submission-start-date: 03/22/2013 01:00 PM
    fiscal-year: FY 2013
    ...
    non-monetary-incentives-awarded: "$8000 total; at discretion of sponsor"
