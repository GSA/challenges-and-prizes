...
tagline: The NASA Office of the Chief Information Officer (OCIO) is deploying a new
  Enterprise Search Engine and is seeking to expand the capabilities beyond the current
  offering to include enhancements in filtering, geolocation, content types, imagery
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 02/10/2016 12:00 AM
    why-use-prizes: ''
    submission-start-date: '09/29/2015 12:00 AM'
    fiscal-year: FY 2015
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '50200'
    campaign-owner: ''
...
showTitle: true
description: Robust search capabilities are increasingly becoming more critical for
  gathering information or requirements to accomplish the day-to-day work of NASA
  employees. The NASA Office of the Chief Information Officer (OCIO) is deploying
  a new Enterprise Search Engine and is seeking to expand the capabilities beyond
  the current offering to include enhancements in filtering, geolocation, content
  types, imagery discovery and machine learning.
...
groupId: 281
showTagline: true
name: Improving NASA Enterprise Search Capabilities
privateCampaign: true
ideaCount: 0
memberIdeaAttachmentAllowed: false
authorEdit: false
permalink: "/challenge/improving-nasa-enterprise-search-capabilities/"
layout: json-page
---