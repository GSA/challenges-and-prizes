...
tagline: Building predictive models to outpace the spread of infectious disease
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 02/01/2015 05:00 AM
    why-use-prizes: ''
    submission-start-date: '08/15/2014 04:00 AM'
    fiscal-year: FY 2014
    public-voting-end-date: ''
    budget-and-resources: ''
    total-prize-offered-cash: '450000'
    campaign-owner: ''
    ...
    non-monetary-incentives-awarded: 'This Challenge has a special award structure
      with awards of $150,000 and $100,000 for the top two overall Solvers and four
      honorable mention awards of $50,000 each. In addition, top Solvers in each Methodology
      Category (data, robustness, applicability, presentation, and computation) may
      win $10,000. '
...
showTitle: true
description: DARPA desires novel approaches to predictive modeling of vector-borne
  infectious diseases to forecast when and where the Chikungunya virus will spread
  in the Americas. There are numerous sources of potentially useful data that could
  be incorporated into a forecast, but its difficult to predict which will be most
  informative. DARPA expects that successful teams will bridge disciplines such as
  public health, mathematics, meteorology, entomology, computer science, and bioinformatics.
