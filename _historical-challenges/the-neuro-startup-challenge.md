...
tagline: Want an opportunity to launch a startup based on NIH inventions? Join the
  Neuro Startup Challenge and learn the business of science and have the chance to
  win prize money, be an entrepreneur and impact brain health!
...
campaignAttributes:
  attributes:
    ...
    total-prize-offered-cash: '48000'
    campaign-owner: ''
    ...
    solution-type: ''
    partner-agencies-non-federal: Center for Advancing Innovation, Heritage Provider
      Network
    original-post-id: '69962'
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: "$3000 for the winning business plan per invention."
    prize-cash-amount-0: '48000'
    prize-name-0: ''
  - prize-description-1: ''
    prize-cash-amount-1: ''
    prize-name-1: ''
...
authorEdit: false
permalink: "/challenge/the-neuro-startup-challenge/"
layout: json-page
---