---
ideaSubmitFormInstruction: <ul>   <li>Submit a team registration before January 7,
  2015 by going to <a href="http://wp.wpi.edu/challenge/">http://wp.wpi.edu/challenge/</a></li>  </ul>
...
tagline: Demonstrate an autonomous robot can locate and collect geologic samples
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 01/07/2016 12:00 AM
    why-use-prizes: ''
    submission-start-date: 10/26/2015 12:00 AM
    fiscal-year: FY 2016
    ...
    judging-end-date: '09/06/2016 12:00 AM'
    solicitation-methods: ''
    advancing-the-agency-mission: ''
    rules: For challenge rules, go to http://wp.wpi.edu/challenge/2012-13-challenge-documents-information/2015-16-challenge-rules/
    submission-start-date-1: ''
    hide-challenge-timeline: 'No'
    judging-start-date: 06/07/2016 12:00 AM
    winners-announced-date: '09/05/2016 12:00 AM'
    ...
    number-of-phases: ''
    how-to-enter: "<ul>\r\n\t<li>Submit a team registration before January 7, 2015
      by going to <a href=\"http://wp.wpi.edu/challenge/\">http://wp.wpi.edu/challenge/</a></li>\r\n</ul>"
    partnerships: ''
  groupAttributes:
  - judging-criteria-description-0: For judging criteria, go to http://wp.wpi.edu/challenge/2012-13-challenge-documents-information/2015-16-challenge-rules/
  ...
  - judging-criteria-description-9: ''
    ...
    judging-criteria-9: ''
  - prize-description-0: 'Technology Achievement $1000 from WPI for successfully passing
      Level 1 pre-inspection  Level 1: Maximum $5000 per team  Level 2: Gradient prize
      awards determined by number of samples collected, up to $1.39 million'
    prize-cash-amount-0: '1500000'
    prize-name-0: Centennial Challenges Sample Return Robot
  - prize-description-1: ''
    prize-cash-amount-1: ''
    prize-name-1: ''
...
showTitle: true
description: The objective is to encourage innovations in autonomous navigation and
  robotic manipulator technologies.  Level 1 of the competition requires teams to
  locate the pre-cached sample and one easy sample in a 30-minute time frame and return
  them to the starting platform.  In Level 2, teams have two hours to retrieve the
  pre-cached sample and as many unknown samples as possible.  The Level 1 competition
  will be held June 8-13, 2016 and Level 2 will be September 2-5, 2016.
...
authorEdit: false
permalink: "/challenge/sample-return-robot-challenge/"
layout: json-page
---