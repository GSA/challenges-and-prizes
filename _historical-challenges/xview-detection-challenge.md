...
tagline: Analyze the largest publicly available dataset of overhead images
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 07/08/2018 11:59 PM
    why-use-prizes: ''
    ...
    campaign-owner-email: johanna.ctr@diux.mil
    solution-type: ''
    partner-agencies-non-federal: ''
    original-post-id: '175250'
