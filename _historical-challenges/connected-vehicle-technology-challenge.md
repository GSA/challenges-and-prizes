...
tagline: With new wireless technology, vehicles can talk to each other. The DOT challenged
  the public to share ideas for what vehicles should say.
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 05/02/2011 03:59 AM
    why-use-prizes: ''
    ...
    total-submission-received: '75'
    total-number-of-participant: ''
    show-winners-instead-of-prizes: 'No'
    estimated-value-of-partner-contributions: ''
    non-monetary-incentives-awarded: 'Finalists (6): Conference invitation; Particpation
      invitation; Paid travel'
