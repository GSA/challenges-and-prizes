...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 01/04/2016 12:00 PM
    why-use-prizes: ''
    ...
    campaign-owner: Lee Mockensturm
    ...
    non-monetary-incentives-awarded: "$300,000 total; (1) $100,000 (2-5) $50,000 each"
    ...
    campaign-owner-email: lee.mockensturm@usdoj.gov
    solution-type: Ideas
...
showTitle: true
description: This competition hopes to create incentives for agencies to use low-cost
  RCTs as a standard and straightforward approach to answering their questions and
  conducting their day-to-day business operations. Prizes will be awarded to the first
  five agencies to complete five successful RCTs.
...
authorEdit: false
permalink: "/challenge/nij-randomized-controlled-trial-challenge-in-criminal-justice-agencies/"
layout: json-page
---