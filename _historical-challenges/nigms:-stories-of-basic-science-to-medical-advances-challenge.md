...
tagline: This Challenge aims to track medical advances stemming from NIGMS-supported
  basic science.
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: "$500 to up to 10 winners"
...
showTitle: true
description: The National Institute of General Medical Sciences seeks the publics
  help in capturing our progress toward our strategic goal to advance awareness and
  understanding of the basic biomedical research enterprise. The goal of the Challenge
  is to identify past advances that are serving (or have served) to improve human
  health and well-being. We will use these examples to help inform the historical
  context of scientific breakthroughs and our role in supporting them.
