...
tagline: Help all Americans be able to download their health data with a Blue Button(sm)
...
campaignAttributes:
  attributes:
    ...
    external-url: http://bluebutton.challengepost.com/submissions
    submission-end-date: 10/19/2011 03:00 AM
    why-use-prizes: ''
    submission-start-date: 07/18/2011 04:00 AM
    fiscal-year: FY 2011
    ...
    non-monetary-incentives-awarded: '1st (1): $50,000'
...
authorEdit: false
permalink: "/challenge/blue-button-for-all-americans/"
layout: json-page
---