...
tagline: The Seeker is soliciting innovative, detailed research proposals to develop
  the state of the art in synthetic biology to solve specific manufacturing challeges
  in two areas
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933056
    submission-end-date: 10/17/2014 04:00 AM
    why-use-prizes: ''
    submission-start-date: '09/02/2014 04:00 AM'
    fiscal-year: FY 2014
    ...
    non-monetary-incentives-awarded: top award potentially being $50K and no award
      less than $5K depending on creativity and completeness of the proposal.
...
showTitle: true
description: We are looking for innovative, detailed research proposals to develop
  the state of science and engineering in synthetic biology to a level where it is
  able to solve specific manufacturing challenges in two defined interest areas.  Emphasis
  will be on a viable research approach that includes potential collaborators.   Winners
  may be invited to a special workshop (reasonable expenses paid) to connect with
  people from other disciplines for submittal against a potential larger multi-year
  award.
