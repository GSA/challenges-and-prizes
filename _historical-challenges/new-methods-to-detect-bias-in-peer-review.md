...
tagline: CSR is seeking new methods to detect possible bias in the peer review of
  grant applications based on gender, race/ethnicity, area of science, and amount
...
showTitle: true
description: The NIH Center for Scientific Review (CSR) is seeking ideas for the detection
  of bias in peer review of grant applications. CSR is particularly interested in
  ...
  area of science, and amount of research experience of applicants. Prizes for best
  empirically-based and most create entries will be awarded.
