...
tagline: Awards for Members of the Military Health System Dedicated to Quality, Patient
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 10/14/2014 04:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: Recognition at conference
...
showTitle: true
description: The DoD Quality, Patient Safety, and Innovation Award recognizes efforts
  designed to decrease harm, improve the care delivered within the MHS, and identify
  grassroots initiatives that have demonstrated an impact at the Military Treatment
  Facility (MTF) level. All managed care support contractors, overseas contractors,
  and designated providers are encouraged to submit. Questions about the process can
  be sent to patientsafety@dha.mil or mhsinnovations@dha.mil
