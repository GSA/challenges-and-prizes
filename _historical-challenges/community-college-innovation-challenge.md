...
tagline: Seeking STEM-based solutions for issues of local to global concern
...
campaignAttributes:
  attributes:
    ...
    submission-end-date: 01/15/2015 05:00 AM
    why-use-prizes: ''
    ...
    non-monetary-incentives-awarded: |-
      Each student member of the first-place team will receive $3,000.
      Each student member of the second-place team will receive $2,000.
      Each student member of the third-place team will receive $1,000.
...
showTitle: true
description: Community colleges are an integral part of our national education system
  and play a key role in training America's technical workforce. The National Science
  Foundation (NSF) invites teams of community college students to identify key problems
  and propose innovative solutions in the areas of big data, broadening participation
  in STEM, sustainability, improving STEM education and infrastructure security. Finalists
  will be invited to a three-day Innovation Boot Camp and compete to win cash prizes.
