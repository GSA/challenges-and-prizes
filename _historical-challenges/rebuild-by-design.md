...
tagline: A Planning and Design Competition for Increasing Resilience in the Sandy
  Region
...
campaignAttributes:
  attributes:
    ...
    total-submission-received: '150'
    total-number-of-participant: ''
    show-winners-instead-of-prizes: 'No'
    estimated-value-of-partner-contributions: ''
    non-monetary-incentives-awarded: Public recognition; Implementation of design
...
showTitle: true
description: Rebuild by Design (RBD) is an initiative of the Hurricane Sandy Rebuilding
  Task Force and the U.S. Department of Housing and Urban Development. It's goal is
  to develop innovative, fundable, and implementable solutions to better protect residents
  from future storms and climate events.     RBD was a multi-phase process beginning
  with regional research and analysis, which then led to site-specific design development.
  The entire process is rooted in strong community engagement and public outreach.
...
authorEdit: false
permalink: "/challenge/rebuild-by-design/"
layout: json-page
---