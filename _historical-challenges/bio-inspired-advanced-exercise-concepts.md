...
tagline: This Challenge seeks bio-inspired approaches for compact and efficient Advanced
  Exercise Concepts (AECs)
...
campaignAttributes:
  attributes:
    ...
    external-url: https://www.innocentive.com/ar/challenge/9933803
    submission-end-date: 12/16/2015 12:00 AM
    why-use-prizes: ''
    submission-start-date: 10/16/2015 12:00 AM
    fiscal-year: FY 2015
    ...
    campaign-owner-email: allison.n.wolff@nasa.gov
    solution-type: Ideas
    partner-agencies-non-federal: ''
    original-post-id: '90111'
...
showTitle: true
description: This Challenge seeks bio-inspired approaches for compact and efficient
  Advanced Exercise Concepts (AECs). These concepts are needed to counteract muscular
  atrophy and improve the overall wellness of astronauts living in zero-gravity during
  a 21 day mission.
