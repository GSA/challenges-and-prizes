...
tagline: The NASA Tournament Lab and the NASA Center for Climate Simulation (NCCS)
  launch challenge to find new sources of observational data for climate modeling.
...
campaignAttributes:
  attributes:
    ...
    non-monetary-incentives-awarded: '6000'
