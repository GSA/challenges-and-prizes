...
tagline: The Department of Health and Human Services is challenging the public to
  help enroll uninsured children in Medicaid or CHIP coverage.
...
campaignAttributes:
  attributes:
    ...
    external-url: ''
    submission-end-date: '09/07/2015 11:00 PM'
    why-use-prizes: ''
...
authorEdit: false
permalink: "/challenge/connecting-kids-to-coverage-challenge/"
layout: json-page
---