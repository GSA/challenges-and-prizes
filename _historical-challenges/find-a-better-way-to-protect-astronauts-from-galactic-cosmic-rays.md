...
campaignAttributes:
  attributes:
    ...
    total-prize-offered-cash: '12000'
    campaign-owner: ''
...
showTitle: true
description: '<span style="font-size: 12.5pt; font-family: Cambria; background-image:
  ...
  is needed to allow for safe and successful human missions such as going to Mars. </span>'
